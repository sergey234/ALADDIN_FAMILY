...
5. **Сессия UX + prod incidents 2026-06-27:** **`docs/VPN_FULL_SESSION_HANDOFF_ML_2026-06-27.md`**
6. **Resilient stack + investor brief:** **`docs/VPN_RESILIENT_ARCHITECTURE_PLAN_2026.md`**, **`docs/VPN_INVESTOR_BRIEF_2026.md`**
7. Наблюдаемость vpn-api: **`../aladdin_shop_vpn_api/deploy/VPN15_OBSERVABILITY_RUNBOOK.md`** (от этой папки `docs/`).
8. Единый выкат: **`../aladdin_shop_vpn_api/deploy/VPN17_DEPLOY_RUNBOOK.md`**.
...
| 2026-06-27 | Ссылка на **`VPN_FULL_SESSION_HANDOFF_ML_2026-06-27.md`** — UX, клиенты, OpenVPN TCP 443, прод-фиксы бота. |
