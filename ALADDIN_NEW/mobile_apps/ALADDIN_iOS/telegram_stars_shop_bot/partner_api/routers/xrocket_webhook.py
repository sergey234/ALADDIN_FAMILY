...
async def xrocket_pay_webhook(
    ...
    if is_topup_crypto_payload(payload_s):
        ...
        idem = f"xrocket:topup:{invoice_id}"
        ...
        try:
            ...
            await conn.rollback()
            _log.exception("xrocket_webhook_topup_failed")
            raise HTTPException(
    ...
    try:
        ...
        await orders_repo.set_payment_rail(conn, order_id=order_id, payment_rail="xrocket")
