...
class ElderlyProtectionInterface(SecurityBase):
    ...
    async def get_safety_lessons(self, user_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "completed_lessons": sum(
                    1 for lesson in lessons if lesson.get("completed", False)
                ),
            }
        except Exception as e:
    ...
    async def get_emergency_contacts(self, user_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "total_contacts": len(profile.emergency_contacts)
                + len(profile.family_contacts),
            }
        except Exception as e:
    ...
    async def set_interface_mode(
        self, user_id: str, mode: str, protection_level: str = None
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if protection_level:
                try:
                    profile.protection_level = ProtectionLevel(
                        protection_level
                    )
                except ValueError:
                    return {
                        "error": f"Неверный уровень защиты: {protection_level}"
                    }
