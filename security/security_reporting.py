# -*- coding: utf-8 -*-
"""
ALADDIN Security System - SecurityReporting
...
class SecurityReporting(SecurityBase):
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        super().__init__("SecurityReporting")
        self.name = "SecurityReporting"
        self.description = "Отчетность по безопасности"
