...
Цветовая палитра для веб-интерфейса, мобильного приложения и всех UI
компонентов
...
class MatrixAIColorScheme:
    ...
    def generate_css_file(
        self, theme: ColorTheme = None, filename: str = None
    ) -> str:
        ...
        if filename is None:
            filename = (
                f"security/static/css/matrix_ai_colors_{theme.value}.css"
            )
