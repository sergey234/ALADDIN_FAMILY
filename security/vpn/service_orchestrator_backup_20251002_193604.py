    ...
    def _initialize_services(self) -> None:
        ...
        new_services = {
            "graphql_api": {
                ...
                "enabled": True,
                "port": 8080,
                "dependencies": ["vpn_core", "vpn_monitoring"]
            },
            "websocket_api": {
                "name": "WebSocket API", 
                "enabled": True,
            ...
            "ml_detector": {
                ...
                "enabled": True,
                "port": None,
                "dependencies": ["vpn_monitoring", "vpn_analytics"]
            },
            "business_analytics": {
                "name": "Business Analytics",
                "enabled": True,
                "port": None,
                "dependencies": ["vpn_analytics", "database"]
            }
        }
        ...
        self.config["services"].update(new_services)
        ...
        for service_id, service_data in self.config.get("services", {}).items():
            if service_data.get("enabled", False):
                try:
                    ...
                    # Пропускаем неизвестные типы сервисов
                    continue
