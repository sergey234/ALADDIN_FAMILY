...
class VPNUser:
    ...
    def can_connect(self) -> bool:
        ...
        return self.is_active() and self.current_connections < self.max_devices
...
class VPNManager:
        ...
        default_config = {
            ...
            "subscription_plans": {
                "personal": {
                    "price": 5,
                    "max_devices": 1,
                    "features": ["basic_protection"],
                },
                "family": {
                    "price": 15,
                    "max_devices": 5,
                    "features": ["basic_protection", "parental_control"],
                },
                "business": {
                    "price": 50,
                    "max_devices": 20,
                    "features": ["basic_protection", "priority_support"],
                },
                "enterprise": {
                    "price": 200,
                    "max_devices": -1,
                    "features": ["all_features", "sla", "custom_server"],
                },
            },
        }
    ...
    async def create_user(
        ...
        if max_devices is None:
            plan_config = self.config["subscription_plans"][
