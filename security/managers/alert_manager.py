    ...
    async def send_alert(
        ...
        try:
            ...
            if not isinstance(severity, AlertSeverity):
                raise ValueError(
                    "severity должен быть экземпляром AlertSeverity"
                )
            ...
            if template_name is not None and not isinstance(
                template_name, str
            ):
    ...
    async def add_recipient(self, recipient: AlertRecipient) -> None:
        ...
        try:
            ...
            if not isinstance(recipient, AlertRecipient):
                raise ValueError(
                    "recipient должен быть экземпляром AlertRecipient"
                )
            if not recipient.user_id or not isinstance(recipient.user_id, str):
                raise ValueError(
                    "recipient.user_id должен быть непустой строкой"
                )
