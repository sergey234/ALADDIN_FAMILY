...
# -*- coding: utf-8 -*-
"""
Скрипт для регистрации Identity Theft Protection Agent в SFM на сервере
"""
...
def register_agent():
    ...
    print("🔍 Регистрация Identity Theft Protection Agent в SFM...")
    print()
    
    # Проверка существования registry
    if not REGISTRY_PATH.exists():
        print(f"❌ Registry не найден: {REGISTRY_PATH}")
        print(f"   Создаем новый registry...")
    ...
    if not ENTRY_PATH.exists():
        ...
        print(f"   Убедитесь, что файл скопирован на сервер!")
        return False
    ...
    print(f"   Identity Theft Protection функций: {len(new_entry.get('functions', []))}")
    print("=" * 80)
    print()
    print("✅ Identity Theft Protection успешно зарегистрирован в SFM!")
