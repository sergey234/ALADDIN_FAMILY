...
#ifndef ALADDIN_SWIFT_H
#define ALADDIN_SWIFT_H
...
SWIFT_CLASS("_TtC7ALADDIN14NetworkManager")
...
@interface NetworkManager (SWIFT_EXTENSION(ALADDIN)) <NSURLSessionDelegate>
...
SWIFT_CLASS("_TtC7ALADDIN19NotificationManager")
...
@interface NotificationManager (SWIFT_EXTENSION(ALADDIN)) <UNUserNotificationCenterDelegate>
