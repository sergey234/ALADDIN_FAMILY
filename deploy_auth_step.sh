#!/bin/bash
# Скрипт деплоя auth.py (точно как deploy_step.sh)

LOG="/Users/sergejhlystov/ALADDIN_NEW/ALADDIN_NEW/mobile_apps/ALADDIN_iOS/deploy_auth.log"
...
echo ""
echo "✅ Деплой завершен! Проверьте лог: $LOG"
