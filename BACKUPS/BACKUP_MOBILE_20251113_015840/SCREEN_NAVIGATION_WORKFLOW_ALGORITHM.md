...
Этот алгоритм описывает полный процесс работы с экранами и навигацией в iOS проекте ALADDIN. Все изменения основаны на HTML wireframes и следуют принципам стабильной навигации.
