    ...
    var body: some View {
        ScrollView {
            VStack(spacing: Spacing.l) {
                ...
                // Action Buttons
                VStack(spacing: Spacing.m) {
                    SecondaryButton(title: localizationManager.localized("device_detail_block_device")) {
                        print("Block device")
                    }
                    ...
                    SecondaryButton(title: localizationManager.localized("device_detail_remove_device")) {
                        print("Remove device")
                    }
...
struct DeviceSettingsView: View {
    ...
    var body: some View {
        VStack(spacing: Spacing.m) {
            ALADDINToggle(localizationManager.localized("device_detail_protection_enabled"), isOn: $isProtectionOn)
            ALADDINToggle(localizationManager.localized("device_detail_scanning_enabled"), isOn: $isScanningEnabled)
        }
        .padding(.horizontal, Spacing.screenPadding)
    }
}
