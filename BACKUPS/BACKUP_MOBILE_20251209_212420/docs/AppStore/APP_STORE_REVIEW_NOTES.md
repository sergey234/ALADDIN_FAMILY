...
2. На сайте https://aladdin-ai.ru выбрать тариф и оплатить **любым доступным методом**:
   - СБП (QR-код или перевод)
   - SberPay
   - Tinkoff Pay
   - Банковские карты (Сбербанк, Тинькофф, Альфа-Банк, ВТБ и др.)
   - Ручной перевод на карту
   - И другие методы (всего 20+ методов оплаты)
...
- Убедиться, что на сайте и в приложении одинаковый текст: "Оплата происходит на сайте aladdin-ai.ru любым доступным методом (СБП, SberPay, карты и др.). После оплаты вы получите код активации и введёте его в приложении".
