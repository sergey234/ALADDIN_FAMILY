...
**Дата:** 2026-02-12 02:06:13
**Base URL:** http://149.154.65.180:8002
**Family ID:** FAM_FB75B46D9405
...
|-------|------|--------|------|------------|-------------------|--------------|-----------|
| POST | `/api/auth/login` | ⚠️ validation_error | 422 | 31.3 | ✅ | 55/100 | ⚠️ |
| POST | `/api/auth/register` | ⚠️ validation_error | 422 | 28.93 | ✅ | 55/100 | ⚠️ |
| POST | `/api/auth/refresh` | ⚠️ validation_error | 422 | 27.85 | ✅ | 55/100 | ⚠️ |
| POST | `/api/auth/login-by-recovery-code` | ⚠️ validation_error | 422 | 37.12 | ✅ | 75/100 | ⚠️ |
| POST | `/api/auth/logout` | ✅ success | 200 | 31.6 | ✅ | 75/100 | ✅ |
| GET | `/api/referral/code` | ✅ success | 200 | 46.49 | ✅ | 80/100 | ✅ |
| GET | `/api/referral/stats` | ✅ success | 200 | 32.13 | ✅ | 80/100 | ✅ |
| GET | `/api/referral/history` | ✅ success | 200 | 30.94 | ✅ | 80/100 | ✅ |
| GET | `/api/referral/rewards` | ✅ success | 200 | 33.03 | ✅ | 80/100 | ✅ |
| POST | `/api/referral/test/payment/create` | ⚠️ validation_error | 422 | 55.47 | ✅ | 75/100 | ⚠️ |
| POST | `/api/referral/test/payment/confirm` | ⚠️ validation_error | 422 | 28.41 | ✅ | 75/100 | ⚠️ |
| GET | `/api/referral/test/discount/apply` | ⚠️ validation_error | 422 | 30.53 | ✅ | 80/100 | ⚠️ |
| POST | `/api/payments/create` | ⚠️ validation_error | 422 | 32.63 | ✅ | 75/100 | ⚠️ |
| GET | `/api/payments/status/{payment_id}` | ❌ not_found | 404 | 33.81 | ✅ | 80/100 | ✅ |
| POST | `/api/payments/confirm` | ⚠️ validation_error | 422 | 30.5 | ✅ | 75/100 | ⚠️ |
| POST | `/api/payments/recover` | ⚠️ validation_error | 422 | 29.47 | ✅ | 75/100 | ⚠️ |
| POST | `/api/activation/retrieve` | ⚠️ validation_error | 422 | 28.31 | ✅ | 75/100 | ⚠️ |
| GET | `/api/components/status/{component_id}` | ❌ not_found | 404 | 30.17 | ✅ | 80/100 | ✅ |
| POST | `/api/components/enable/{component_id}` | ❌ not_found | 404 | 40.22 | ✅ | 75/100 | ✅ |
| POST | `/api/components/disable/{component_id}` | ❌ not_found | 404 | 31.81 | ✅ | 75/100 | ✅ |
| GET | `/api/components/configuration/{component_id}` | ❌ not_found | 404 | 39.95 | ✅ | 80/100 | ✅ |
| POST | `/api/components/configuration/{component_id}` | ⚠️ validation_error | 422 | 28.86 | ✅ | 75/100 | ⚠️ |
| POST | `/api/components/batch/status` | ⚠️ validation_error | 422 | 28.97 | ✅ | 75/100 | ⚠️ |
| GET | `/api/protection/settings` | ✅ success | 200 | 33.55 | ✅ | 80/100 | ✅ |
| POST | `/api/protection/settings` | ⚠️ validation_error | 422 | 31.52 | ✅ | 75/100 | ⚠️ |
| GET | `/api/protection/status` | ✅ success | 200 | 29.85 | ✅ | 80/100 | ✅ |
| GET | `/api/protection/threat-scenarios` | ✅ success | 200 | 32.49 | ✅ | 80/100 | ✅ |
| POST | `/api/protection/enable` | ⚠️ validation_error | 422 | 29.36 | ✅ | 75/100 | ⚠️ |
| POST | `/api/protection/disable` | ⚠️ validation_error | 422 | 30.25 | ✅ | 75/100 | ⚠️ |
| GET | `/api/protection/stats` | ✅ success | 200 | 30.1 | ✅ | 80/100 | ✅ |
| POST | `/api/protection/sync` | ⚠️ validation_error | 422 | 32.21 | ✅ | 75/100 | ⚠️ |
| GET | `/api/family/stats` | ✅ success | 200 | 30.14 | ✅ | 80/100 | ✅ |
| POST | `/api/family/create` | ⚠️ validation_error | 422 | 27.28 | ✅ | 75/100 | ⚠️ |
| GET | `/api/reports/ai-categories/stats` | ✅ success | 200 | 28.41 | ✅ | 80/100 | ✅ |
| GET | `/api/reports/ai-categories/reports` | ✅ success | 200 | 37.78 | ✅ | 80/100 | ✅ |
| POST | `/api/reports/ai-categories/allow` | ⚠️ validation_error | 422 | 35.02 | ✅ | 75/100 | ⚠️ |
| POST | `/api/reports/ai-categories/block` | ⚠️ validation_error | 422 | 29.6 | ✅ | 75/100 | ⚠️ |
| GET | `/api/reports/ai-categories/health` | ✅ success | 200 | 45.31 | ✅ | 80/100 | ✅ |
| GET | `/api/reports/privacy/tracker/stats` | ✅ success | 200 | 40.24 | ✅ | 80/100 | ✅ |
| GET | `/api/reports/privacy/tracker/top` | ✅ success | 200 | 29.67 | ✅ | 80/100 | ✅ |
| POST | `/api/reports/privacy/tracker/whitelist` | ⚠️ validation_error | 422 | 28.66 | ✅ | 75/100 | ⚠️ |
| GET | `/api/reports/privacy/tracker/health` | ✅ success | 200 | 26.96 | ✅ | 80/100 | ✅ |
| POST | `/api/crash-detection/setup` | ⚠️ validation_error | 422 | 41.3 | ✅ | 75/100 | ⚠️ |
| POST | `/api/crash-detection/alert` | ⚠️ validation_error | 422 | 30.59 | ✅ | 75/100 | ⚠️ |
| POST | `/api/crash-detection/start` | ✅ success | 200 | 29.31 | ✅ | 75/100 | ✅ |
| POST | `/api/crash-detection/stop` | ✅ success | 200 | 33.26 | ✅ | 75/100 | ✅ |
| POST | `/api/crash-detection/data` | ⚠️ validation_error | 422 | 41.87 | ✅ | 75/100 | ⚠️ |
| GET | `/api/crash-detection/status` | ✅ success | 200 | 41.32 | ✅ | 80/100 | ✅ |
| POST | `/reports/privacy/location/bubble` | ⚠️ validation_error | 422 | 27.95 | ✅ | 75/100 | ⚠️ |
| POST | `/reports/privacy/location/send` | ⚠️ validation_error | 422 | 38.23 | ✅ | 75/100 | ⚠️ |
| GET | `/api/reports/dark-web/stats` | ✅ success | 200 | 38.44 | ✅ | 80/100 | ✅ |
| GET | `/api/reports/dark-web/leaks` | ✅ success | 200 | 30.66 | ✅ | 80/100 | ✅ |
| GET | `/api/reports/dark-web/scans` | ✅ success | 200 | 38.66 | ✅ | 80/100 | ✅ |
| POST | `/api/reports/dark-web/resolve` | ⚠️ validation_error | 422 | 61.17 | ✅ | 75/100 | ⚠️ |
| POST | `/api/reports/dark-web/scan/start` | ✅ success | 200 | 29.12 | ✅ | 75/100 | ✅ |
| POST | `/api/reports/dark-web/scan/secure` | ✅ success | 200 | 28.92 | ✅ | 75/100 | ✅ |
| POST | `/api/reports/dark-web/scan/fast` | ✅ success | 200 | 27.79 | ✅ | 75/100 | ✅ |
| GET | `/api/reports/dark-web/health` | ✅ success | 200 | 31.17 | ✅ | 80/100 | ✅ |
| GET | `/api/reports/privacy/cleanup/stats` | ✅ success | 200 | 35.24 | ✅ | 80/100 | ✅ |
| GET | `/api/reports/privacy/cleanup/records` | ✅ success | 200 | 34.72 | ✅ | 80/100 | ✅ |
| POST | `/api/reports/privacy/cleanup/start` | ✅ success | 200 | 39.52 | ✅ | 75/100 | ✅ |
| GET | `/api/reports/privacy/cleanup/health` | ✅ success | 200 | 36.1 | ✅ | 80/100 | ✅ |
| GET | `/api/reports/identity-theft/stats` | ✅ success | 200 | 35.86 | ✅ | 80/100 | ✅ |
| GET | `/api/reports/identity-theft/attempts` | ✅ success | 200 | 33.43 | ✅ | 80/100 | ✅ |
| POST | `/api/reports/identity-theft/allow` | ⚠️ validation_error | 422 | 30.41 | ✅ | 75/100 | ⚠️ |
| POST | `/api/reports/identity-theft/block` | ⚠️ validation_error | 422 | 30.59 | ✅ | 75/100 | ⚠️ |
| POST | `/api/reports/identity-theft/whitelist` | ⚠️ validation_error | 422 | 31.67 | ✅ | 75/100 | ⚠️ |
| GET | `/api/reports/identity-theft/health` | ✅ success | 200 | 34.63 | ✅ | 80/100 | ✅ |
| GET | `/api/reports/privacy/location/stats` | ✅ success | 200 | 32.4 | ✅ | 80/100 | ✅ |
| GET | `/api/reports/privacy/location/requests` | ✅ success | 200 | 28.92 | ✅ | 80/100 | ✅ |
| POST | `/api/reports/privacy/location/allow` | ⚠️ validation_error | 422 | 27.88 | ✅ | 75/100 | ⚠️ |
| POST | `/api/reports/privacy/location/block` | ⚠️ validation_error | 422 | 28.39 | ✅ | 75/100 | ⚠️ |
| POST | `/api/reports/privacy/location/update-accuracy` | ⚠️ validation_error | 422 | 34.41 | ✅ | 75/100 | ⚠️ |
| GET | `/api/reports/privacy/location/health` | ✅ success | 200 | 27.46 | ✅ | 80/100 | ✅ |
| POST | `/api/roadside-assistance/call` | ⚠️ validation_error | 422 | 32.7 | ✅ | 75/100 | ⚠️ |
| GET | `/api/roadside-assistance/status/{request_id}` | ❌ not_found | 404 | 31.12 | ✅ | 80/100 | ✅ |
| POST | `/api/roadside-assistance/cancel/{request_id}` | ✅ success | 200 | 30.02 | ✅ | 75/100 | ✅ |
| GET | `/api/roadside-assistance/history` | ⚠️ validation_error | 422 | 28.07 | ✅ | 80/100 | ⚠️ |
| GET | `/api/roadside-assistance/health` | ✅ success | 200 | 42.65 | ✅ | 80/100 | ✅ |
| GET | `/api/v1/parental-control/stats` | ✅ success | 200 | 31.35 | ✅ | 80/100 | ✅ |
| GET | `/api/v1/parental-control/status` | ✅ success | 200 | 34.36 | ✅ | 80/100 | ✅ |
| GET | `/parental/bypass/stats` | ✅ success | 200 | 34.14 | ✅ | 80/100 | ✅ |
| GET | `/parental/bypass/status` | ✅ success | 200 | 29.58 | ✅ | 80/100 | ✅ |
| GET | `/api/iot/status/{homeId}` | ✅ success | 200 | 27.6 | ✅ | 80/100 | ✅ |
| GET | `/api/iot/devices/{homeId}` | ✅ success | 200 | 30.27 | ✅ | 80/100 | ✅ |
| GET | `/api/iot/threats/{homeId}` | ✅ success | 200 | 30.67 | ✅ | 80/100 | ✅ |
| POST | `/api/iot/device/{deviceId}/block` | ✅ success | 200 | 28.92 | ✅ | 75/100 | ✅ |
| POST | `/api/iot/scan/{homeId}` | ✅ success | 200 | 35.52 | ✅ | 75/100 | ✅ |
| POST | `/api/iot/fix/{threatId}` | ✅ success | 200 | 26.76 | ✅ | 75/100 | ✅ |
| GET | `/api/reports/driving/stats` | ✅ success | 200 | 28.21 | ✅ | 80/100 | ✅ |
| GET | `/api/reports/driving/export` | ✅ success | 200 | 54.36 | ✅ | 80/100 | ✅ |
| GET | `/api/reports/driving/health` | ✅ success | 200 | 26.52 | ✅ | 80/100 | ✅ |
| GET | `/api/notifications` | ✅ success | 200 | 60.59 | ✅ | 80/100 | ✅ |
| POST | `/api/notifications/read` | ⚠️ validation_error | 422 | 56.48 | ✅ | 75/100 | ⚠️ |
| GET | `/api/notifications/stats` | ✅ success | 200 | 32.03 | ✅ | 80/100 | ✅ |
| GET | `/api/notifications/unread_count` | ✅ success | 200 | 192.22 | ✅ | 80/100 | ✅ |
| POST | `/api/notifications/mark_read/{notification_id}` | ❌ not_found | 404 | 26.73 | ✅ | 75/100 | ✅ |
| POST | `/api/notifications/delete/{notification_id}` | ❌ not_found | 404 | 29.7 | ✅ | 75/100 | ✅ |
| POST | `/api/notifications/bulk_mark_read` | ⚠️ validation_error | 422 | 29.47 | ✅ | 75/100 | ⚠️ |
| POST | `/api/notifications/test` | ✅ success | 200 | 31.02 | ✅ | 75/100 | ✅ |
| PUT | `/api/notifications/settings` | ✅ success | 200 | 26.72 | ✅ | 75/100 | ✅ |
| GET | `/api/notifications/categories` | ✅ success | 200 | 34.41 | ✅ | 80/100 | ✅ |
| GET | `/api/notifications/preferences` | ✅ success | 200 | 31.35 | ✅ | 80/100 | ✅ |
| PUT | `/api/notifications/preferences` | ⚠️ validation_error | 422 | 27.82 | ✅ | 75/100 | ⚠️ |
| POST | `/api/notifications/clear_all` | ✅ success | 200 | 27.33 | ✅ | 75/100 | ✅ |
| POST | `/api/notifications/archive/{notification_id}` | ✅ success | 200 | 35.77 | ✅ | 75/100 | ✅ |
| POST | `/api/notifications/unarchive/{notification_id}` | ✅ success | 200 | 29.65 | ✅ | 75/100 | ✅ |
| GET | `/api/notifications/filter` | ✅ success | 200 | 41.09 | ✅ | 80/100 | ✅ |
| GET | `/api/notifications/search` | ⚠️ validation_error | 422 | 32.03 | ✅ | 80/100 | ⚠️ |
| GET | `/api/notifications/export` | ✅ success | 200 | 32.93 | ✅ | 80/100 | ✅ |
| POST | `/api/ai/assistant/chat` | ⚠️ validation_error | 422 | 63.96 | ✅ | 75/100 | ⚠️ |
| GET | `/api/ai/assistant/history` | ✅ success | 200 | 29.9 | ✅ | 80/100 | ✅ |
| POST | `/api/ai/assistant/feedback` | ⚠️ validation_error | 422 | 30.86 | ✅ | 75/100 | ⚠️ |
| GET | `/api/ai/assistant/capabilities` | ✅ success | 200 | 27.59 | ✅ | 80/100 | ✅ |
| POST | `/api/ai/assistant/analyze_threat` | ⚠️ validation_error | 422 | 28.18 | ✅ | 75/100 | ⚠️ |
| GET | `/api/ai/assistant/recommendations` | ✅ success | 200 | 40.9 | ✅ | 80/100 | ✅ |
| POST | `/api/ai/assistant/report_incident` | ⚠️ validation_error | 422 | 28.99 | ✅ | 75/100 | ⚠️ |
| GET | `/api/ai/assistant/security_tips` | ✅ success | 200 | 27.27 | ✅ | 80/100 | ✅ |
| GET | `/api/components/health` | ✅ success | 200 | 34.73 | ✅ | 80/100 | ✅ |
| GET | `/api/components/list` | ✅ success | 200 | 28.52 | ✅ | 80/100 | ✅ |
| GET | `/api/components/status/all` | ❌ not_found | 404 | 39.77 | ✅ | 80/100 | ✅ |
| GET | `/api/components/config/{component_id}` | ✅ success | 200 | 27.83 | ✅ | 80/100 | ✅ |
| POST | `/api/components/config/update/{component_id}` | ⚠️ validation_error | 422 | 27.6 | ✅ | 75/100 | ⚠️ |
| POST | `/api/components/restart/{component_id}` | ✅ success | 200 | 35.82 | ✅ | 75/100 | ✅ |
| GET | `/api/components/metrics/{component_id}` | ✅ success | 200 | 29.72 | ✅ | 80/100 | ✅ |
| GET | `/api/components/logs/{component_id}` | ✅ success | 200 | 28.85 | ✅ | 80/100 | ✅ |
| GET | `/api/components/dependencies/{component_id}` | ✅ success | 200 | 26.47 | ✅ | 80/100 | ✅ |
| POST | `/api/components/test/{component_id}` | ✅ success | 200 | 36.08 | ✅ | 75/100 | ✅ |
| POST | `/api/components/update/{component_id}` | ✅ success | 200 | 41.72 | ✅ | 75/100 | ✅ |
| GET | `/api/system/health` | ✅ success | 200 | 30.76 | ✅ | 80/100 | ✅ |
| GET | `/api/system/info` | ✅ success | 200 | 36.33 | ✅ | 80/100 | ✅ |
| GET | `/api/system/logs` | ✅ success | 200 | 49.4 | ✅ | 80/100 | ✅ |
| POST | `/api/system/maintenance` | ⚠️ validation_error | 422 | 30.81 | ✅ | 75/100 | ⚠️ |
| GET | `/api/system/metrics` | ✅ success | 200 | 34.67 | ✅ | 80/100 | ✅ |
| POST | `/api/system/backup` | ✅ success | 200 | 29.66 | ✅ | 75/100 | ✅ |
| GET | `/api/system/backup/status` | ✅ success | 200 | 28.24 | ✅ | 80/100 | ✅ |
| GET | `/api/system/uptime` | ✅ success | 200 | 32.45 | ✅ | 80/100 | ✅ |
| GET | `/api/system/version` | ✅ success | 200 | 32.04 | ✅ | 80/100 | ✅ |
| POST | `/api/system/restart` | ✅ success | 200 | 30.35 | ✅ | 75/100 | ✅ |
| GET | `/api/system/resources` | ✅ success | 200 | 54.13 | ✅ | 80/100 | ✅ |
| GET | `/api/gamification/balance/{userId}` | ✅ success | 200 | 29.0 | ✅ | 80/100 | ✅ |
| POST | `/api/gamification/balance/add` | ⚠️ validation_error | 422 | 27.99 | ✅ | 75/100 | ⚠️ |
| POST | `/api/gamification/balance/subtract` | ⚠️ validation_error | 422 | 31.74 | ✅ | 75/100 | ⚠️ |
| GET | `/api/gamification/balance/history` | ✅ success | 200 | 30.29 | ✅ | 80/100 | ✅ |
| GET | `/api/gamification/rewards` | ✅ success | 200 | 27.37 | ✅ | 80/100 | ✅ |
| POST | `/api/gamification/rewards/claim` | ⚠️ validation_error | 422 | 33.32 | ✅ | 75/100 | ⚠️ |
| GET | `/api/gamification/rewards/history` | ⚠️ validation_error | 422 | 28.89 | ✅ | 80/100 | ⚠️ |
| POST | `/api/gamification/rewards/give` | ⚠️ validation_error | 422 | 39.37 | ✅ | 75/100 | ⚠️ |
| GET | `/api/gamification/rewards/shop` | ✅ success | 200 | 27.26 | ✅ | 80/100 | ✅ |
| POST | `/api/gamification/rewards/purchase` | ⚠️ validation_error | 422 | 31.64 | ✅ | 75/100 | ⚠️ |
| GET | `/api/gamification/achievements` | ⚠️ validation_error | 422 | 30.43 | ✅ | 80/100 | ⚠️ |
| POST | `/api/gamification/achievements/unlock` | ⚠️ validation_error | 422 | 31.41 | ✅ | 75/100 | ⚠️ |
| GET | `/api/gamification/achievements/progress` | ⚠️ validation_error | 422 | 48.06 | ✅ | 80/100 | ⚠️ |
| GET | `/api/gamification/achievements/{achievementId}` | ✅ success | 200 | 71.09 | ✅ | 80/100 | ✅ |
| POST | `/api/gamification/achievements/claim` | ⚠️ validation_error | 422 | 28.48 | ✅ | 75/100 | ⚠️ |
| GET | `/api/gamification/tournaments` | ✅ success | 200 | 31.56 | ✅ | 80/100 | ✅ |
| POST | `/api/gamification/tournaments/join` | ⚠️ validation_error | 422 | 31.86 | ✅ | 75/100 | ⚠️ |
| GET | `/api/gamification/tournaments/{tournamentId}` | ✅ success | 200 | 66.98 | ✅ | 80/100 | ✅ |
| GET | `/api/gamification/tournaments/leaderboard` | ✅ success | 200 | 32.78 | ✅ | 80/100 | ✅ |
| POST | `/api/gamification/tournaments/leave` | ⚠️ validation_error | 422 | 30.42 | ✅ | 75/100 | ⚠️ |
| GET | `/api/gamification/tournaments/history` | ✅ success | 200 | 38.76 | ✅ | 80/100 | ✅ |
| GET | `/api/gamification/settings` | ⚠️ validation_error | 422 | 30.21 | ✅ | 80/100 | ⚠️ |
| POST | `/api/gamification/settings/update` | ⚠️ validation_error | 422 | 34.81 | ✅ | 75/100 | ⚠️ |
| GET | `/api/gamification/settings/notifications` | ⚠️ validation_error | 422 | 32.83 | ✅ | 80/100 | ⚠️ |
| POST | `/api/gamification/settings/notifications/update` | ⚠️ validation_error | 422 | 28.66 | ✅ | 75/100 | ⚠️ |
| GET | `/api/gamification/progress` | ⚠️ validation_error | 422 | 35.48 | ✅ | 80/100 | ⚠️ |
| POST | `/api/gamification/progress/update` | ⚠️ validation_error | 422 | 28.73 | ✅ | 75/100 | ⚠️ |
| GET | `/api/gamification/progress/stats` | ⚠️ validation_error | 422 | 27.02 | ✅ | 80/100 | ⚠️ |
| GET | `/api/gamification/progress/level` | ⚠️ validation_error | 422 | 28.62 | ✅ | 80/100 | ⚠️ |
| POST | `/api/gamification/progress/reset` | ⚠️ validation_error | 422 | 38.79 | ✅ | 75/100 | ⚠️ |
| GET | `/api/parental-control/settings/{familyId}` | ✅ success | 200 | 28.86 | ✅ | 80/100 | ✅ |
| POST | `/api/parental-control/settings/update` | ⚠️ validation_error | 422 | 40.71 | ✅ | 75/100 | ⚠️ |
| GET | `/api/parental-control/settings/history` | ✅ success | 200 | 30.66 | ✅ | 80/100 | ✅ |
| POST | `/api/parental-control/settings/sync` | ⚠️ validation_error | 422 | 28.18 | ✅ | 75/100 | ⚠️ |
| GET | `/api/parental-control/settings/conflicts` | ✅ success | 200 | 28.67 | ✅ | 80/100 | ✅ |
| GET | `/api/parental-control/time-limits/{childId}` | ✅ success | 200 | 30.69 | ✅ | 80/100 | ✅ |
| POST | `/api/parental-control/time-limits/update` | ⚠️ validation_error | 422 | 36.57 | ✅ | 75/100 | ⚠️ |
| GET | `/api/parental-control/time-limits/history` | ✅ success | 200 | 29.0 | ✅ | 80/100 | ✅ |
| POST | `/api/parental-control/time-limits/reset` | ⚠️ validation_error | 422 | 28.16 | ✅ | 75/100 | ⚠️ |
| GET | `/api/parental-control/schedules/{childId}` | ✅ success | 200 | 31.0 | ✅ | 80/100 | ✅ |
| POST | `/api/parental-control/schedules/update` | ⚠️ validation_error | 422 | 32.91 | ✅ | 75/100 | ⚠️ |
| GET | `/api/parental-control/schedules/history` | ✅ success | 200 | 32.12 | ✅ | 80/100 | ✅ |
| POST | `/api/parental-control/schedules/delete` | ⚠️ validation_error | 422 | 36.42 | ✅ | 75/100 | ⚠️ |
| GET | `/api/parental-control/geofences/{childId}` | ✅ success | 200 | 34.28 | ✅ | 80/100 | ✅ |
| POST | `/api/parental-control/geofences/add` | ⚠️ validation_error | 422 | 32.27 | ✅ | 75/100 | ⚠️ |
| POST | `/api/parental-control/geofences/update` | ⚠️ validation_error | 422 | 43.39 | ✅ | 75/100 | ⚠️ |
| DELETE | `/api/parental-control/geofences/{geofenceId}` | ✅ success | 200 | 27.6 | ✅ | 75/100 | ✅ |
| GET | `/api/parental-control/app-blocks/{childId}` | ✅ success | 200 | 29.4 | ✅ | 80/100 | ✅ |
| POST | `/api/parental-control/app-blocks/update` | ⚠️ validation_error | 422 | 33.02 | ✅ | 75/100 | ⚠️ |
| POST | `/api/parental-control/app-blocks/sync` | ⚠️ validation_error | 422 | 32.62 | ✅ | 75/100 | ⚠️ |
| POST | `/api/user/profile/sync` | ⚠️ validation_error | 422 | 32.56 | ✅ | 75/100 | ⚠️ |
| POST | `/api/user/profile/update` | ⚠️ validation_error | 422 | 28.33 | ✅ | 75/100 | ⚠️ |
| GET | `/api/user/profile/history` | ⚠️ validation_error | 422 | 28.9 | ✅ | 80/100 | ⚠️ |
| GET | `/api/user/profile/privacy` | ⚠️ validation_error | 422 | 31.36 | ✅ | 80/100 | ⚠️ |
| POST | `/api/user/profile/privacy/update` | ⚠️ validation_error | 422 | 35.79 | ✅ | 75/100 | ⚠️ |
| POST | `/api/subscription/sync` | ⚠️ validation_error | 422 | 30.79 | ✅ | 75/100 | ⚠️ |
| POST | `/api/subscription/update` | ⚠️ validation_error | 422 | 30.84 | ✅ | 75/100 | ⚠️ |
| GET | `/api/subscription/purchase-history` | ⚠️ validation_error | 422 | 29.71 | ✅ | 80/100 | ⚠️ |
| GET | `/api/subscription/status` | ⚠️ validation_error | 422 | 30.98 | ✅ | 80/100 | ⚠️ |
| POST | `/api/subscription/status/update` | ⚠️ validation_error | 422 | 32.91 | ✅ | 75/100 | ⚠️ |
| GET | `/api/subscription/auto-renewal` | ⚠️ validation_error | 422 | 42.98 | ✅ | 80/100 | ⚠️ |
| POST | `/api/subscription/auto-renewal/update` | ⚠️ validation_error | 422 | 36.98 | ✅ | 75/100 | ⚠️ |
| POST | `/api/subscription/cancel` | ⚠️ validation_error | 422 | 35.31 | ✅ | 75/100 | ⚠️ |
| POST | `/api/settings/sync` | ⚠️ validation_error | 422 | 27.92 | ✅ | 75/100 | ⚠️ |
| POST | `/api/settings/update` | ⚠️ validation_error | 422 | 50.98 | ✅ | 75/100 | ⚠️ |
| GET | `/api/settings/theme` | ⚠️ validation_error | 422 | 29.83 | ✅ | 80/100 | ⚠️ |
| POST | `/api/settings/theme/update` | ⚠️ validation_error | 422 | 28.25 | ✅ | 75/100 | ⚠️ |
| GET | `/api/settings/language` | ⚠️ validation_error | 422 | 28.45 | ✅ | 80/100 | ⚠️ |
| POST | `/api/settings/language/update` | ⚠️ validation_error | 422 | 27.91 | ✅ | 75/100 | ⚠️ |
| GET | `/api/settings/notifications` | ⚠️ validation_error | 422 | 31.99 | ✅ | 80/100 | ⚠️ |
| POST | `/api/settings/notifications/update` | ⚠️ validation_error | 422 | 28.08 | ✅ | 75/100 | ⚠️ |
| GET | `/api/settings/biometry` | ⚠️ validation_error | 422 | 28.19 | ✅ | 80/100 | ⚠️ |
| POST | `/api/settings/biometry/update` | ⚠️ validation_error | 422 | 29.15 | ✅ | 75/100 | ⚠️ |
| POST | `/api/location/geofences/sync` | ⚠️ validation_error | 422 | 37.06 | ✅ | 75/100 | ⚠️ |
| POST | `/api/location/geofences/update` | ⚠️ validation_error | 422 | 29.05 | ✅ | 75/100 | ⚠️ |
| DELETE | `/api/location/geofences/{geofenceId}` | ✅ success | 200 | 28.35 | ✅ | 75/100 | ✅ |
| GET | `/api/location/movement-history` | ⚠️ validation_error | 422 | 30.49 | ✅ | 80/100 | ⚠️ |
| POST | `/api/location/movement-history/update` | ⚠️ validation_error | 422 | 34.18 | ✅ | 75/100 | ⚠️ |
| GET | `/api/location/status` | ⚠️ validation_error | 422 | 28.24 | ✅ | 80/100 | ⚠️ |
| POST | `/api/location/status/update` | ⚠️ validation_error | 422 | 38.36 | ✅ | 75/100 | ⚠️ |
| POST | `/api/chat/offline-messages/sync` | ⚠️ validation_error | 422 | 33.54 | ✅ | 75/100 | ⚠️ |
| POST | `/api/chat/offline-messages/send` | ⚠️ validation_error | 422 | 30.73 | ✅ | 75/100 | ⚠️ |
| POST | `/api/chat/offline-messages/resolve-conflicts` | ⚠️ validation_error | 422 | 28.63 | ✅ | 75/100 | ⚠️ |
| POST | `/api/offline-storage/sync` | ⚠️ validation_error | 422 | 27.84 | ✅ | 75/100 | ⚠️ |
| GET | `/api/offline-storage/data` | ⚠️ validation_error | 422 | 29.45 | ✅ | 80/100 | ⚠️ |
| POST | `/api/offline-storage/data/update` | ⚠️ validation_error | 422 | 31.96 | ✅ | 75/100 | ⚠️ |
| DELETE | `/api/offline-storage/data/{dataId}` | ⚠️ validation_error | 422 | 31.93 | ✅ | 75/100 | ⚠️ |
| POST | `/api/offline-storage/resolve-conflicts` | ⚠️ validation_error | 422 | 28.6 | ✅ | 75/100 | ⚠️ |
| POST | `/api/crash-detection/sync` | ⚠️ validation_error | 422 | 29.4 | ✅ | 75/100 | ⚠️ |
| POST | `/api/crash-detection/report` | ⚠️ validation_error | 422 | 32.87 | ✅ | 75/100 | ⚠️ |
| GET | `/api/crash-detection/notifications` | ⚠️ validation_error | 422 | 29.06 | ✅ | 80/100 | ⚠️ |
| POST | `/api/crash-detection/notifications/send` | ⚠️ validation_error | 422 | 29.85 | ✅ | 75/100 | ⚠️ |
| POST | `/api/elderly/medications/sync` | ⚠️ validation_error | 422 | 31.23 | ✅ | 75/100 | ⚠️ |
| POST | `/api/elderly/medications/update` | ⚠️ validation_error | 422 | 29.58 | ✅ | 75/100 | ⚠️ |
| POST | `/api/elderly/appointments/sync` | ⚠️ validation_error | 422 | 33.37 | ✅ | 75/100 | ⚠️ |
| POST | `/api/elderly/appointments/update` | ⚠️ validation_error | 422 | 28.34 | ✅ | 75/100 | ⚠️ |
| GET | `/` | ⏭️ skipped | N/A | N/A | ✅ | N/A/100 | ✅ |
| GET | `/api/health` | ✅ success | 200 | 88.76 | ✅ | 80/100 | ✅ |
