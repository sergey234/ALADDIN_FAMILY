    ...
    var body: some View {
        ...
        .sheet(isPresented: $showShareSheet) {
            ShareSheet(activityItems: [
                "🎁 Присоединяйтесь к ALADDIN! Защитите свою семью от киберугроз и получите скидку 20%! Используйте мой код: ALADDIN-SH2024\n\nСкачайте приложение: https://aladdin.family\n\nЗа каждого друга вы получите 500₽ бонуса!"
            ])
        }
        ...
        VStack(spacing: Spacing.m) {
            ...
            VStack(spacing: Spacing.s) {
                ...
                settingsButton(
                    ...
                    subtitle: selectedTheme.displayName, // ThemeMode уже локализован внутри enum
                    action: {
                        cycleTheme()
                    }
                )
