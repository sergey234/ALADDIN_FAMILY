...
struct AppConfig {
    ...
    static let minimumClientBuildForApiContract = "1"
    static let bundleIdentifier = "ai.aladdin"
    ...
    enum Endpoint {
        ...
        static let aiCompanionTeenSettings = "/api/ai/companion/profile/teen-settings"
        ...
        static let aiCompanionTTS = "/api/ai/companion/tts"
        static let aiCompanionSTT = "/api/ai/companion/stt"
        ...
        static let wellnessJournal = "/api/wellness/journal"
        static let wellnessTriggersStatus = "/api/wellness/triggers/status"
        static let wellnessNudgeIdleDismiss = "/api/wellness/nudges/idle/dismiss"
        static let wellnessSettings = "/api/wellness/settings"
        static let wellnessParentShare = "/api/wellness/settings/parent-share"
        static let wellnessPhqLiteSchema = "/api/wellness/assessments/phq-lite/schema"
        static let wellnessPhqLiteSubmit = "/api/wellness/assessments/phq-lite/submit"
        static let wellnessPhq9Schema = "/api/wellness/assessments/phq-9/schema"
        static let wellnessPhq9Submit = "/api/wellness/assessments/phq-9/submit"
        static let wellnessGad7Schema = "/api/wellness/assessments/gad-7/schema"
        static let wellnessGad7Submit = "/api/wellness/assessments/gad-7/submit"
        static let wellnessMbiLiteSchema = "/api/wellness/assessments/mbi-lite/schema"
        static let wellnessMbiLiteSubmit = "/api/wellness/assessments/mbi-lite/submit"
        static let wellnessOutcomesDismissPrompt = "/api/wellness/outcomes/dismiss-prompt"
        static let wellnessReflectiveModes = "/api/wellness/reflective/modes"
        static let wellnessTraumaCheck = "/api/wellness/trauma/check"
        static let wellnessAlliance = "/api/wellness/alliance"
        static let wellnessHubCopy = "/api/wellness/hub/copy"
        static let wellnessWeeklyMeaning = "/api/wellness/weekly-meaning"
        static let wellnessWeeklyMeaningDismiss = "/api/wellness/weekly-meaning/dismiss"
        static let wellnessStreaks = "/api/wellness/streaks"
        static let wellnessTogetherSession = "/api/wellness/together/session"
        static let wellnessClinicianExport = "/api/wellness/export/clinician"
        static let wellnessFamilyThemes = "/api/wellness/family/themes"
        static let wellnessParentPlaybook = "/api/wellness/parent/playbook"
        static let wellnessExportPdfLabels = "/api/wellness/export/pdf-labels"
        static let wellnessWidgetCopy = "/api/wellness/widget/copy"
        static let wellnessPremiumEligibility = "/api/wellness/premium/eligibility"
        static let wellnessValuesCard = "/api/wellness/humanistic/values-card"
        ...
        static let wellnessSessionLoop = "/api/wellness/session/loop"
        static let wellnessSessionRecap = "/api/wellness/session/recap"
        static let wellnessExercisesCatalog = "/api/wellness/exercises/catalog"
        static let wellnessExercisesActive = "/api/wellness/exercises/active"
        static let wellnessExercisesStart = "/api/wellness/exercises/start"
        static let wellnessTimeline = "/api/wellness/timeline"
        static let wellnessOutcomes = "/api/wellness/outcomes"
        static let wellnessDreams = "/api/wellness/dreams"

        static func wellnessExerciseStep(_ id: Int) -> String {
            "/api/wellness/exercises/\(id)/step"
        }
