...
class DeviceRegisterRequest(BaseModel):
    ...
    device_type: str = Field("ios", alias="device_type")

    model_config = {"populate_by_name": True}

class TrialDeviceRegisterRequest(BaseModel):
    """Anonymous device registration request with trial info."""
    device_id: str = Field(..., alias="device_id")
    device_type: str = Field("ios", alias="device_type")
    trial_info: dict = Field(default_factory=dict, alias="trial_info")
