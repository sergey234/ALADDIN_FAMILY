#!/usr/bin/env python3
"""
ПОЛНАЯ ТАБЛИЦА ВСЕХ 40 BACKUP ФАЙЛОВ с правильным поиском оригиналов
"""
...
def create_complete_comparison_table():
    # Пути
    ...
    print('📊 ПОЛНАЯ ТАБЛИЦА ВСЕХ 40 BACKUP ФАЙЛОВ vs ОРИГИНАЛЫ')
    print('=' * 150)
    ...
    for i, backup_file in enumerate(backup_files, 1):
        ...
        # Ищем оригинал ВО ВСЕХ ПАПКАХ (включая duplicates)
...
if __name__ == "__main__":
    create_complete_comparison_table()