...
# -*- coding: utf-8 -*-
"""
Простой HTTP сервер для тестирования VPN без Flask
"""
...
def init_vpn_system():
    ...
    global vpn_system
    try:
        vpn_system = VPNSecuritySystem("SimpleVPNServer")
...
def main():
    """Основная функция"""
    print("🌍 ЗАПУСК ПРОСТОГО VPN СЕРВЕРА")
    print("=" * 40)
    ...
    try:
        with socketserver.TCPServer(("", PORT), Handler) as httpd:
            ...
            print(f"�� С телефона: http://[IP_АДРЕС]:{PORT}")
