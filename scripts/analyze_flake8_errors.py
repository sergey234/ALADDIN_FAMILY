#!/usr/bin/env python3
"""
Анализ ошибок flake8 и создание графиков
"""
            ...
            for line in f:
                if ':' in line and any(code in line for code in ['E', 'W', 'F']):
                    ...
                    if len(parts) >= 4:
                        ...
                        if error_part:
                            error_code = error_part.split()[0] if error_part.split() else "UNKNOWN"
                            if error_code.startswith(('E', 'W', 'F')):
...
def create_comparison_chart(data, filename):
    ...
    error_types = ['E501', 'W293', 'E302', 'F401', 'E128', 'F811', 'E402', 'W291']
...
def main():
    ...
    report = {
        "analysis_timestamp": "2025-09-13T22:50:00",
        "categories": {}
    }
