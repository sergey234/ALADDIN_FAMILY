...
struct ProfileEditView: View {
    ...
    var body: some View {
        ...
        .onAppear {
            ...
            if name.isEmpty {
                name = storedName.isEmpty ? localizationManager.localized("profile_edit_default_name") : storedName
            }
            if email.isEmpty {
                email = storedEmail.isEmpty ? localizationManager.localized("profile_edit_default_email") : storedEmail
            }
            if phone.isEmpty {
                phone = storedPhone.isEmpty ? localizationManager.localized("profile_edit_default_phone") : storedPhone
            }
        }
    }
