...
struct ReferralScreen: View {
    ...
    private func referralRow(referral: ReferralHistory) -> some View {
        ...
        .accessibilityElement(children: .combine)
        .accessibilityLabel(String(format: localizationManager.localized("referral_history_accessibility"), referral.name, referral.date, referral.reward))
    }
    ...
    private var referralHistory: [ReferralHistory] {
        [
            ReferralHistory(name: String(format: localizationManager.localized("referral_history_item_name"), 1), date: localizationManager.localized("referral_history_date_2_days"), reward: "-20%", status: .completed),
            ReferralHistory(name: String(format: localizationManager.localized("referral_history_item_name"), 2), date: localizationManager.localized("referral_history_date_1_week"), reward: "-20%", status: .completed),
            ReferralHistory(name: String(format: localizationManager.localized("referral_history_item_name"), 3), date: localizationManager.localized("referral_history_date_2_weeks"), reward: localizationManager.localized("referral_status_pending"), status: .pending)
        ]
    }
