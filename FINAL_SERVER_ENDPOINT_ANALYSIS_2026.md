...
| Параметр | Значение |
|----------|----------|
| **Спецификация ALADDIN (полная система)** | **259 endpoint'ов** |
| **Эндпоинтов на сервере (OpenAPI)** | **236 endpoint'ов** |
| **Эндпоинтов в api_gateway_complete_full.py** | **202 endpoint'ов** |
| **Рабочих эндпоинтов на сервере** | **150-170 endpoint'ов** |
| **404 ошибок после развертывания** | **30-50 endpoint'ов** |
| **Процент реализации от спецификации** | **91%** (236/259) |
