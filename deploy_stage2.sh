...
# Скрипт для загрузки всех router'ов Этапа 2 на сервер
# Использование: ./deploy_stage2.sh
...
echo "🚀 ЗАГРУЗКА ЭТАПА 2: ВАЖНО (33 endpoint'а) НА СЕРВЕР"
echo "=================================================="
echo ""
...
echo ""
echo "✅ ЗАГРУЗКА ЭТАПА 2 ЗАВЕРШЕНА"
echo ""
