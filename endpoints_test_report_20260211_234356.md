...
**Дата:** 2026-02-11 23:43:56
**Base URL:** http://149.154.65.180:8002
**Family ID:** FAM_A1E906F3EBAB
...
|-------|------|--------|------|------------|-------------------|--------------|-----------|
| POST | `/api/auth/login` | ⚠️ validation_error | 422 | 25.31 | ✅ | 55/100 | ⚠️ |
| POST | `/api/auth/register` | ⚠️ validation_error | 422 | 26.43 | ✅ | 55/100 | ⚠️ |
| POST | `/api/auth/refresh` | ⚠️ validation_error | 422 | 25.47 | ✅ | 55/100 | ⚠️ |
| POST | `/api/auth/login-by-recovery-code` | ⚠️ validation_error | 422 | 25.41 | ✅ | 75/100 | ⚠️ |
| POST | `/api/auth/logout` | ✅ success | 200 | 52.68 | ✅ | 75/100 | ✅ |
| GET | `/api/referral/code` | ❌ server_error | 500 | 37.73 | ✅ | 80/100 | ✅ |
| GET | `/api/referral/stats` | ❌ server_error | 500 | 61.68 | ✅ | 80/100 | ✅ |
| GET | `/api/referral/history` | ❌ server_error | 500 | 50.71 | ✅ | 80/100 | ✅ |
| GET | `/api/referral/rewards` | ❌ server_error | 500 | 47.14 | ✅ | 80/100 | ✅ |
| POST | `/api/referral/test/payment/create` | ⚠️ validation_error | 422 | 50.84 | ✅ | 75/100 | ⚠️ |
| POST | `/api/referral/test/payment/confirm` | ⚠️ validation_error | 422 | 27.46 | ✅ | 75/100 | ⚠️ |
| GET | `/api/referral/test/discount/apply` | ⚠️ validation_error | 422 | 26.81 | ✅ | 80/100 | ⚠️ |
| POST | `/api/payments/create` | ⚠️ validation_error | 422 | 27.57 | ✅ | 75/100 | ⚠️ |
| GET | `/api/payments/status/{payment_id}` | ❌ not_found | 404 | 33.8 | ✅ | 80/100 | ✅ |
| POST | `/api/payments/confirm` | ⚠️ validation_error | 422 | 27.02 | ✅ | 75/100 | ⚠️ |
| POST | `/api/payments/recover` | ⚠️ validation_error | 422 | 28.86 | ✅ | 75/100 | ⚠️ |
| POST | `/api/activation/retrieve` | ⚠️ validation_error | 422 | 26.11 | ✅ | 75/100 | ⚠️ |
| GET | `/api/components/status/{component_id}` | ❌ not_found | 404 | 26.83 | ✅ | 80/100 | ✅ |
| POST | `/api/components/enable/{component_id}` | ❌ not_found | 404 | 27.6 | ✅ | 75/100 | ✅ |
| POST | `/api/components/disable/{component_id}` | ❌ not_found | 404 | 27.32 | ✅ | 75/100 | ✅ |
| GET | `/api/components/configuration/{component_id}` | ❌ not_found | 404 | 30.98 | ✅ | 80/100 | ✅ |
| POST | `/api/components/configuration/{component_id}` | ⚠️ validation_error | 422 | 27.5 | ✅ | 75/100 | ⚠️ |
| POST | `/api/components/batch/status` | ⚠️ validation_error | 422 | 31.05 | ✅ | 75/100 | ⚠️ |
| GET | `/api/protection/settings` | ✅ success | 200 | 28.31 | ✅ | 80/100 | ✅ |
| POST | `/api/protection/settings` | ⚠️ validation_error | 422 | 25.04 | ✅ | 75/100 | ⚠️ |
| GET | `/api/protection/status` | ✅ success | 200 | 26.05 | ✅ | 80/100 | ✅ |
| GET | `/api/protection/threat-scenarios` | ✅ success | 200 | 30.96 | ✅ | 80/100 | ✅ |
| POST | `/api/protection/enable` | ⚠️ validation_error | 422 | 25.99 | ✅ | 75/100 | ⚠️ |
| POST | `/api/protection/disable` | ⚠️ validation_error | 422 | 34.0 | ✅ | 75/100 | ⚠️ |
| GET | `/api/protection/stats` | ✅ success | 200 | 25.75 | ✅ | 80/100 | ✅ |
| POST | `/api/protection/sync` | ⚠️ validation_error | 422 | 37.23 | ✅ | 75/100 | ⚠️ |
| GET | `/api/family/stats` | ✅ success | 200 | 29.08 | ✅ | 80/100 | ✅ |
| POST | `/api/family/create` | ⚠️ validation_error | 422 | 29.22 | ✅ | 75/100 | ⚠️ |
| GET | `/api/reports/ai-categories/stats` | ✅ success | 200 | 30.73 | ✅ | 80/100 | ✅ |
| GET | `/api/reports/ai-categories/reports` | ✅ success | 200 | 31.9 | ✅ | 80/100 | ✅ |
| POST | `/api/reports/ai-categories/allow` | ⚠️ validation_error | 422 | 24.8 | ✅ | 75/100 | ⚠️ |
| POST | `/api/reports/ai-categories/block` | ⚠️ validation_error | 422 | 27.1 | ✅ | 75/100 | ⚠️ |
| GET | `/api/reports/ai-categories/health` | ✅ success | 200 | 25.65 | ✅ | 80/100 | ✅ |
| GET | `/api/reports/privacy/tracker/stats` | ✅ success | 200 | 28.12 | ✅ | 80/100 | ✅ |
| GET | `/api/reports/privacy/tracker/top` | ✅ success | 200 | 106.53 | ✅ | 80/100 | ✅ |
| POST | `/api/reports/privacy/tracker/whitelist` | ⚠️ validation_error | 422 | 27.94 | ✅ | 75/100 | ⚠️ |
| GET | `/api/reports/privacy/tracker/health` | ✅ success | 200 | 38.47 | ✅ | 80/100 | ✅ |
| POST | `/api/crash-detection/setup` | ⚠️ validation_error | 422 | 29.4 | ✅ | 75/100 | ⚠️ |
| POST | `/api/crash-detection/alert` | ⚠️ validation_error | 422 | 70.61 | ✅ | 75/100 | ⚠️ |
| POST | `/api/crash-detection/start` | ✅ success | 200 | 111.56 | ✅ | 75/100 | ✅ |
| POST | `/api/crash-detection/stop` | ✅ success | 200 | 56.61 | ✅ | 75/100 | ✅ |
| POST | `/api/crash-detection/data` | ⚠️ validation_error | 422 | 29.25 | ✅ | 75/100 | ⚠️ |
| GET | `/api/crash-detection/status` | ✅ success | 200 | 29.66 | ✅ | 80/100 | ✅ |
| POST | `/reports/privacy/location/bubble` | ⚠️ validation_error | 422 | 71.09 | ✅ | 75/100 | ⚠️ |
| POST | `/reports/privacy/location/send` | ⚠️ validation_error | 422 | 29.83 | ✅ | 75/100 | ⚠️ |
| GET | `/api/reports/dark-web/stats` | ✅ success | 200 | 29.2 | ✅ | 80/100 | ✅ |
| GET | `/api/reports/dark-web/leaks` | ✅ success | 200 | 49.46 | ✅ | 80/100 | ✅ |
| GET | `/api/reports/dark-web/scans` | ✅ success | 200 | 28.69 | ✅ | 80/100 | ✅ |
| POST | `/api/reports/dark-web/resolve` | ⚠️ validation_error | 422 | 26.36 | ✅ | 75/100 | ⚠️ |
| POST | `/api/reports/dark-web/scan/start` | ✅ success | 200 | 30.17 | ✅ | 75/100 | ✅ |
| POST | `/api/reports/dark-web/scan/secure` | ✅ success | 200 | 31.14 | ✅ | 75/100 | ✅ |
| POST | `/api/reports/dark-web/scan/fast` | ✅ success | 200 | 25.81 | ✅ | 75/100 | ✅ |
| GET | `/api/reports/dark-web/health` | ✅ success | 200 | 25.41 | ✅ | 80/100 | ✅ |
| GET | `/api/reports/privacy/cleanup/stats` | ✅ success | 200 | 34.02 | ✅ | 80/100 | ✅ |
| GET | `/api/reports/privacy/cleanup/records` | ✅ success | 200 | 41.47 | ✅ | 80/100 | ✅ |
| POST | `/api/reports/privacy/cleanup/start` | ✅ success | 200 | 25.73 | ✅ | 75/100 | ✅ |
| GET | `/api/reports/privacy/cleanup/health` | ✅ success | 200 | 24.96 | ✅ | 80/100 | ✅ |
| GET | `/api/reports/identity-theft/stats` | ✅ success | 200 | 29.95 | ✅ | 80/100 | ✅ |
| GET | `/api/reports/identity-theft/attempts` | ✅ success | 200 | 28.01 | ✅ | 80/100 | ✅ |
| POST | `/api/reports/identity-theft/allow` | ⚠️ validation_error | 422 | 25.45 | ✅ | 75/100 | ⚠️ |
| POST | `/api/reports/identity-theft/block` | ⚠️ validation_error | 422 | 26.47 | ✅ | 75/100 | ⚠️ |
| POST | `/api/reports/identity-theft/whitelist` | ⚠️ validation_error | 422 | 26.04 | ✅ | 75/100 | ⚠️ |
| GET | `/api/reports/identity-theft/health` | ✅ success | 200 | 24.77 | ✅ | 80/100 | ✅ |
| GET | `/api/reports/privacy/location/stats` | ✅ success | 200 | 24.84 | ✅ | 80/100 | ✅ |
| GET | `/api/reports/privacy/location/requests` | ✅ success | 200 | 30.54 | ✅ | 80/100 | ✅ |
| POST | `/api/reports/privacy/location/allow` | ⚠️ validation_error | 422 | 25.43 | ✅ | 75/100 | ⚠️ |
| POST | `/api/reports/privacy/location/block` | ⚠️ validation_error | 422 | 26.57 | ✅ | 75/100 | ⚠️ |
| POST | `/api/reports/privacy/location/update-accuracy` | ⚠️ validation_error | 422 | 25.04 | ✅ | 75/100 | ⚠️ |
| GET | `/api/reports/privacy/location/health` | ✅ success | 200 | 45.67 | ✅ | 80/100 | ✅ |
| POST | `/api/roadside-assistance/call` | ⚠️ validation_error | 422 | 28.42 | ✅ | 75/100 | ⚠️ |
| GET | `/api/roadside-assistance/status/{request_id}` | ❌ not_found | 404 | 25.47 | ✅ | 80/100 | ✅ |
| POST | `/api/roadside-assistance/cancel/{request_id}` | ✅ success | 200 | 28.89 | ✅ | 75/100 | ✅ |
| GET | `/api/roadside-assistance/history` | ⚠️ validation_error | 422 | 26.45 | ✅ | 80/100 | ⚠️ |
| GET | `/api/roadside-assistance/health` | ✅ success | 200 | 27.26 | ✅ | 80/100 | ✅ |
| GET | `/api/v1/parental-control/stats` | ✅ success | 200 | 25.7 | ✅ | 80/100 | ✅ |
| GET | `/api/v1/parental-control/status` | ✅ success | 200 | 48.33 | ✅ | 80/100 | ✅ |
| GET | `/parental/bypass/stats` | ✅ success | 200 | 24.92 | ✅ | 80/100 | ✅ |
| GET | `/parental/bypass/status` | ✅ success | 200 | 25.82 | ✅ | 80/100 | ✅ |
| GET | `/api/iot/status/{homeId}` | ✅ success | 200 | 25.77 | ✅ | 80/100 | ✅ |
| GET | `/api/iot/devices/{homeId}` | ✅ success | 200 | 27.54 | ✅ | 80/100 | ✅ |
| GET | `/api/iot/threats/{homeId}` | ✅ success | 200 | 26.04 | ✅ | 80/100 | ✅ |
| POST | `/api/iot/device/{deviceId}/block` | ✅ success | 200 | 29.39 | ✅ | 75/100 | ✅ |
| POST | `/api/iot/scan/{homeId}` | ✅ success | 200 | 27.82 | ✅ | 75/100 | ✅ |
| POST | `/api/iot/fix/{threatId}` | ✅ success | 200 | 25.99 | ✅ | 75/100 | ✅ |
| GET | `/api/reports/driving/stats` | ✅ success | 200 | 29.01 | ✅ | 80/100 | ✅ |
| GET | `/api/reports/driving/export` | ✅ success | 200 | 26.81 | ✅ | 80/100 | ✅ |
| GET | `/api/reports/driving/health` | ✅ success | 200 | 38.65 | ✅ | 80/100 | ✅ |
| GET | `/api/notifications` | ✅ success | 200 | 28.5 | ✅ | 80/100 | ✅ |
| POST | `/api/notifications/read` | ⚠️ validation_error | 422 | 27.77 | ✅ | 75/100 | ⚠️ |
| GET | `/api/notifications/stats` | ✅ success | 200 | 41.2 | ✅ | 80/100 | ✅ |
| GET | `/api/notifications/unread_count` | ✅ success | 200 | 31.73 | ✅ | 80/100 | ✅ |
| POST | `/api/notifications/mark_read/{notification_id}` | ❌ not_found | 404 | 27.86 | ✅ | 75/100 | ✅ |
| POST | `/api/notifications/delete/{notification_id}` | ❌ not_found | 404 | 52.31 | ✅ | 75/100 | ✅ |
| POST | `/api/notifications/bulk_mark_read` | ⚠️ validation_error | 422 | 25.68 | ✅ | 75/100 | ⚠️ |
| POST | `/api/notifications/test` | ❌ server_error | 500 | 38.95 | ✅ | 75/100 | ✅ |
| PUT | `/api/notifications/settings` | ✅ success | 200 | 63.84 | ✅ | 75/100 | ✅ |
| GET | `/api/notifications/categories` | ✅ success | 200 | 25.05 | ✅ | 80/100 | ✅ |
| GET | `/api/notifications/preferences` | ✅ success | 200 | 36.11 | ✅ | 80/100 | ✅ |
| PUT | `/api/notifications/preferences` | ⚠️ validation_error | 422 | 28.33 | ✅ | 75/100 | ⚠️ |
| POST | `/api/notifications/clear_all` | ✅ success | 200 | 28.05 | ✅ | 75/100 | ✅ |
| POST | `/api/notifications/archive/{notification_id}` | ✅ success | 200 | 27.32 | ✅ | 75/100 | ✅ |
| POST | `/api/notifications/unarchive/{notification_id}` | ✅ success | 200 | 33.62 | ✅ | 75/100 | ✅ |
| GET | `/api/notifications/filter` | ✅ success | 200 | 25.25 | ✅ | 80/100 | ✅ |
| GET | `/api/notifications/search` | ⚠️ validation_error | 422 | 27.89 | ✅ | 80/100 | ⚠️ |
| GET | `/api/notifications/export` | ✅ success | 200 | 35.66 | ✅ | 80/100 | ✅ |
| POST | `/api/ai/assistant/chat` | ⚠️ validation_error | 422 | 36.36 | ✅ | 75/100 | ⚠️ |
| GET | `/api/ai/assistant/history` | ✅ success | 200 | 50.57 | ✅ | 80/100 | ✅ |
| POST | `/api/ai/assistant/feedback` | ⚠️ validation_error | 422 | 48.81 | ✅ | 75/100 | ⚠️ |
| GET | `/api/ai/assistant/capabilities` | ✅ success | 200 | 29.84 | ✅ | 80/100 | ✅ |
| POST | `/api/ai/assistant/analyze_threat` | ⚠️ validation_error | 422 | 26.91 | ✅ | 75/100 | ⚠️ |
| GET | `/api/ai/assistant/recommendations` | ✅ success | 200 | 116.2 | ✅ | 80/100 | ✅ |
| POST | `/api/ai/assistant/report_incident` | ⚠️ validation_error | 422 | 142.95 | ✅ | 75/100 | ⚠️ |
| GET | `/api/ai/assistant/security_tips` | ✅ success | 200 | 32.41 | ✅ | 80/100 | ✅ |
| GET | `/api/components/health` | ✅ success | 200 | 29.46 | ✅ | 80/100 | ✅ |
| GET | `/api/components/list` | ✅ success | 200 | 25.73 | ✅ | 80/100 | ✅ |
| GET | `/api/components/status/all` | ❌ not_found | 404 | 28.1 | ✅ | 80/100 | ✅ |
| GET | `/api/components/config/{component_id}` | ✅ success | 200 | 43.71 | ✅ | 80/100 | ✅ |
| POST | `/api/components/config/update/{component_id}` | ⚠️ validation_error | 422 | 30.83 | ✅ | 75/100 | ⚠️ |
| POST | `/api/components/restart/{component_id}` | ✅ success | 200 | 32.71 | ✅ | 75/100 | ✅ |
| GET | `/api/components/metrics/{component_id}` | ✅ success | 200 | 46.08 | ✅ | 80/100 | ✅ |
| GET | `/api/components/logs/{component_id}` | ✅ success | 200 | 26.94 | ✅ | 80/100 | ✅ |
| GET | `/api/components/dependencies/{component_id}` | ✅ success | 200 | 28.27 | ✅ | 80/100 | ✅ |
| POST | `/api/components/test/{component_id}` | ✅ success | 200 | 43.61 | ✅ | 75/100 | ✅ |
| POST | `/api/components/update/{component_id}` | ✅ success | 200 | 26.74 | ✅ | 75/100 | ✅ |
| GET | `/api/system/health` | ✅ success | 200 | 25.8 | ✅ | 80/100 | ✅ |
| GET | `/api/system/info` | ✅ success | 200 | 25.44 | ✅ | 80/100 | ✅ |
| GET | `/api/system/logs` | ✅ success | 200 | 30.62 | ✅ | 80/100 | ✅ |
| POST | `/api/system/maintenance` | ⚠️ validation_error | 422 | 25.91 | ✅ | 75/100 | ⚠️ |
| GET | `/api/system/metrics` | ✅ success | 200 | 26.47 | ✅ | 80/100 | ✅ |
| POST | `/api/system/backup` | ✅ success | 200 | 26.52 | ✅ | 75/100 | ✅ |
| GET | `/api/system/backup/status` | ✅ success | 200 | 28.57 | ✅ | 80/100 | ✅ |
| GET | `/api/system/uptime` | ✅ success | 200 | 24.72 | ✅ | 80/100 | ✅ |
| GET | `/api/system/version` | ✅ success | 200 | 26.49 | ✅ | 80/100 | ✅ |
| POST | `/api/system/restart` | ✅ success | 200 | 25.19 | ✅ | 75/100 | ✅ |
| GET | `/api/system/resources` | ✅ success | 200 | 64.86 | ✅ | 80/100 | ✅ |
| GET | `/api/gamification/balance/{userId}` | ✅ success | 200 | 24.6 | ✅ | 80/100 | ✅ |
| POST | `/api/gamification/balance/add` | ⚠️ validation_error | 422 | 26.35 | ✅ | 75/100 | ⚠️ |
| POST | `/api/gamification/balance/subtract` | ⚠️ validation_error | 422 | 56.28 | ✅ | 75/100 | ⚠️ |
| GET | `/api/gamification/balance/history` | ✅ success | 200 | 26.51 | ✅ | 80/100 | ✅ |
| GET | `/api/gamification/rewards` | ✅ success | 200 | 28.72 | ✅ | 80/100 | ✅ |
| POST | `/api/gamification/rewards/claim` | ⚠️ validation_error | 422 | 162.93 | ✅ | 75/100 | ⚠️ |
| GET | `/api/gamification/rewards/history` | ⚠️ validation_error | 422 | 29.18 | ✅ | 80/100 | ⚠️ |
| POST | `/api/gamification/rewards/give` | ⚠️ validation_error | 422 | 30.91 | ✅ | 75/100 | ⚠️ |
| GET | `/api/gamification/rewards/shop` | ✅ success | 200 | 29.76 | ✅ | 80/100 | ✅ |
| POST | `/api/gamification/rewards/purchase` | ⚠️ validation_error | 422 | 26.39 | ✅ | 75/100 | ⚠️ |
| GET | `/api/gamification/achievements` | ⚠️ validation_error | 422 | 38.84 | ✅ | 80/100 | ⚠️ |
| POST | `/api/gamification/achievements/unlock` | ⚠️ validation_error | 422 | 26.7 | ✅ | 75/100 | ⚠️ |
| GET | `/api/gamification/achievements/progress` | ⚠️ validation_error | 422 | 27.9 | ✅ | 80/100 | ⚠️ |
| GET | `/api/gamification/achievements/{achievementId}` | ✅ success | 200 | 27.14 | ✅ | 80/100 | ✅ |
| POST | `/api/gamification/achievements/claim` | ⚠️ validation_error | 422 | 25.2 | ✅ | 75/100 | ⚠️ |
| GET | `/api/gamification/tournaments` | ✅ success | 200 | 39.58 | ✅ | 80/100 | ✅ |
| POST | `/api/gamification/tournaments/join` | ⚠️ validation_error | 422 | 24.9 | ✅ | 75/100 | ⚠️ |
| GET | `/api/gamification/tournaments/{tournamentId}` | ✅ success | 200 | 25.7 | ✅ | 80/100 | ✅ |
| GET | `/api/gamification/tournaments/leaderboard` | ✅ success | 200 | 26.92 | ✅ | 80/100 | ✅ |
| POST | `/api/gamification/tournaments/leave` | ⚠️ validation_error | 422 | 30.35 | ✅ | 75/100 | ⚠️ |
| GET | `/api/gamification/tournaments/history` | ✅ success | 200 | 26.61 | ✅ | 80/100 | ✅ |
| GET | `/api/gamification/settings` | ⚠️ validation_error | 422 | 27.24 | ✅ | 80/100 | ⚠️ |
| POST | `/api/gamification/settings/update` | ⚠️ validation_error | 422 | 43.35 | ✅ | 75/100 | ⚠️ |
| GET | `/api/gamification/settings/notifications` | ⚠️ validation_error | 422 | 25.86 | ✅ | 80/100 | ⚠️ |
| POST | `/api/gamification/settings/notifications/update` | ⚠️ validation_error | 422 | 26.78 | ✅ | 75/100 | ⚠️ |
| GET | `/api/gamification/progress` | ⚠️ validation_error | 422 | 28.5 | ✅ | 80/100 | ⚠️ |
| POST | `/api/gamification/progress/update` | ⚠️ validation_error | 422 | 41.68 | ✅ | 75/100 | ⚠️ |
| GET | `/api/gamification/progress/stats` | ⚠️ validation_error | 422 | 32.74 | ✅ | 80/100 | ⚠️ |
| GET | `/api/gamification/progress/level` | ⚠️ validation_error | 422 | 24.86 | ✅ | 80/100 | ⚠️ |
| POST | `/api/gamification/progress/reset` | ⚠️ validation_error | 422 | 28.77 | ✅ | 75/100 | ⚠️ |
| GET | `/api/parental-control/settings/{familyId}` | ✅ success | 200 | 26.32 | ✅ | 80/100 | ✅ |
| POST | `/api/parental-control/settings/update` | ⚠️ validation_error | 422 | 29.17 | ✅ | 75/100 | ⚠️ |
| GET | `/api/parental-control/settings/history` | ✅ success | 200 | 26.09 | ✅ | 80/100 | ✅ |
| POST | `/api/parental-control/settings/sync` | ⚠️ validation_error | 422 | 25.16 | ✅ | 75/100 | ⚠️ |
| GET | `/api/parental-control/settings/conflicts` | ✅ success | 200 | 59.48 | ✅ | 80/100 | ✅ |
| GET | `/api/parental-control/time-limits/{childId}` | ✅ success | 200 | 80.03 | ✅ | 80/100 | ✅ |
| POST | `/api/parental-control/time-limits/update` | ⚠️ validation_error | 422 | 25.17 | ✅ | 75/100 | ⚠️ |
| GET | `/api/parental-control/time-limits/history` | ✅ success | 200 | 29.3 | ✅ | 80/100 | ✅ |
| POST | `/api/parental-control/time-limits/reset` | ⚠️ validation_error | 422 | 44.01 | ✅ | 75/100 | ⚠️ |
| GET | `/api/parental-control/schedules/{childId}` | ✅ success | 200 | 29.87 | ✅ | 80/100 | ✅ |
| POST | `/api/parental-control/schedules/update` | ⚠️ validation_error | 422 | 36.45 | ✅ | 75/100 | ⚠️ |
| GET | `/api/parental-control/schedules/history` | ✅ success | 200 | 39.18 | ✅ | 80/100 | ✅ |
| POST | `/api/parental-control/schedules/delete` | ⚠️ validation_error | 422 | 28.82 | ✅ | 75/100 | ⚠️ |
| GET | `/api/parental-control/geofences/{childId}` | ✅ success | 200 | 37.65 | ✅ | 80/100 | ✅ |
| POST | `/api/parental-control/geofences/add` | ⚠️ validation_error | 422 | 26.34 | ✅ | 75/100 | ⚠️ |
| POST | `/api/parental-control/geofences/update` | ⚠️ validation_error | 422 | 29.65 | ✅ | 75/100 | ⚠️ |
| DELETE | `/api/parental-control/geofences/{geofenceId}` | ✅ success | 200 | 44.06 | ✅ | 75/100 | ✅ |
| GET | `/api/parental-control/app-blocks/{childId}` | ✅ success | 200 | 25.32 | ✅ | 80/100 | ✅ |
| POST | `/api/parental-control/app-blocks/update` | ⚠️ validation_error | 422 | 26.33 | ✅ | 75/100 | ⚠️ |
| POST | `/api/parental-control/app-blocks/sync` | ⚠️ validation_error | 422 | 28.0 | ✅ | 75/100 | ⚠️ |
| POST | `/api/user/profile/sync` | ⚠️ validation_error | 422 | 26.14 | ✅ | 75/100 | ⚠️ |
| POST | `/api/user/profile/update` | ⚠️ validation_error | 422 | 30.47 | ✅ | 75/100 | ⚠️ |
| GET | `/api/user/profile/history` | ⚠️ validation_error | 422 | 31.01 | ✅ | 80/100 | ⚠️ |
| GET | `/api/user/profile/privacy` | ⚠️ validation_error | 422 | 29.97 | ✅ | 80/100 | ⚠️ |
| POST | `/api/user/profile/privacy/update` | ⚠️ validation_error | 422 | 26.89 | ✅ | 75/100 | ⚠️ |
| POST | `/api/subscription/sync` | ⚠️ validation_error | 422 | 113.25 | ✅ | 75/100 | ⚠️ |
| POST | `/api/subscription/update` | ⚠️ validation_error | 422 | 33.6 | ✅ | 75/100 | ⚠️ |
| GET | `/api/subscription/purchase-history` | ⚠️ validation_error | 422 | 29.28 | ✅ | 80/100 | ⚠️ |
| GET | `/api/subscription/status` | ⚠️ validation_error | 422 | 26.31 | ✅ | 80/100 | ⚠️ |
| POST | `/api/subscription/status/update` | ⚠️ validation_error | 422 | 177.21 | ✅ | 75/100 | ⚠️ |
| GET | `/api/subscription/auto-renewal` | ⚠️ validation_error | 422 | 25.87 | ✅ | 80/100 | ⚠️ |
| POST | `/api/subscription/auto-renewal/update` | ⚠️ validation_error | 422 | 37.04 | ✅ | 75/100 | ⚠️ |
| POST | `/api/subscription/cancel` | ⚠️ validation_error | 422 | 27.66 | ✅ | 75/100 | ⚠️ |
| POST | `/api/settings/sync` | ⚠️ validation_error | 422 | 26.48 | ✅ | 75/100 | ⚠️ |
| POST | `/api/settings/update` | ⚠️ validation_error | 422 | 41.18 | ✅ | 75/100 | ⚠️ |
| GET | `/api/settings/theme` | ⚠️ validation_error | 422 | 27.03 | ✅ | 80/100 | ⚠️ |
| POST | `/api/settings/theme/update` | ⚠️ validation_error | 422 | 186.4 | ✅ | 75/100 | ⚠️ |
| GET | `/api/settings/language` | ⚠️ validation_error | 422 | 26.27 | ✅ | 80/100 | ⚠️ |
| POST | `/api/settings/language/update` | ⚠️ validation_error | 422 | 35.9 | ✅ | 75/100 | ⚠️ |
| GET | `/api/settings/notifications` | ⚠️ validation_error | 422 | 26.38 | ✅ | 80/100 | ⚠️ |
| POST | `/api/settings/notifications/update` | ⚠️ validation_error | 422 | 32.54 | ✅ | 75/100 | ⚠️ |
| GET | `/api/settings/biometry` | ⚠️ validation_error | 422 | 27.39 | ✅ | 80/100 | ⚠️ |
| POST | `/api/settings/biometry/update` | ⚠️ validation_error | 422 | 59.28 | ✅ | 75/100 | ⚠️ |
| POST | `/api/location/geofences/sync` | ⚠️ validation_error | 422 | 25.76 | ✅ | 75/100 | ⚠️ |
| POST | `/api/location/geofences/update` | ⚠️ validation_error | 422 | 40.22 | ✅ | 75/100 | ⚠️ |
| DELETE | `/api/location/geofences/{geofenceId}` | ✅ success | 200 | 27.44 | ✅ | 75/100 | ✅ |
| GET | `/api/location/movement-history` | ⚠️ validation_error | 422 | 31.48 | ✅ | 80/100 | ⚠️ |
| POST | `/api/location/movement-history/update` | ⚠️ validation_error | 422 | 28.05 | ✅ | 75/100 | ⚠️ |
| GET | `/api/location/status` | ⚠️ validation_error | 422 | 35.83 | ✅ | 80/100 | ⚠️ |
| POST | `/api/location/status/update` | ⚠️ validation_error | 422 | 30.86 | ✅ | 75/100 | ⚠️ |
| POST | `/api/chat/offline-messages/sync` | ⚠️ validation_error | 422 | 25.9 | ✅ | 75/100 | ⚠️ |
| POST | `/api/chat/offline-messages/send` | ⚠️ validation_error | 422 | 32.24 | ✅ | 75/100 | ⚠️ |
| POST | `/api/chat/offline-messages/resolve-conflicts` | ⚠️ validation_error | 422 | 26.84 | ✅ | 75/100 | ⚠️ |
| POST | `/api/offline-storage/sync` | ⚠️ validation_error | 422 | 29.07 | ✅ | 75/100 | ⚠️ |
| GET | `/api/offline-storage/data` | ⚠️ validation_error | 422 | 28.18 | ✅ | 80/100 | ⚠️ |
| POST | `/api/offline-storage/data/update` | ⚠️ validation_error | 422 | 28.95 | ✅ | 75/100 | ⚠️ |
| DELETE | `/api/offline-storage/data/{dataId}` | ⚠️ validation_error | 422 | 29.42 | ✅ | 75/100 | ⚠️ |
| POST | `/api/offline-storage/resolve-conflicts` | ⚠️ validation_error | 422 | 32.11 | ✅ | 75/100 | ⚠️ |
| POST | `/api/crash-detection/sync` | ⚠️ validation_error | 422 | 35.18 | ✅ | 75/100 | ⚠️ |
| POST | `/api/crash-detection/report` | ⚠️ validation_error | 422 | 27.6 | ✅ | 75/100 | ⚠️ |
| GET | `/api/crash-detection/notifications` | ⚠️ validation_error | 422 | 27.52 | ✅ | 80/100 | ⚠️ |
| POST | `/api/crash-detection/notifications/send` | ⚠️ validation_error | 422 | 31.77 | ✅ | 75/100 | ⚠️ |
| POST | `/api/elderly/medications/sync` | ⚠️ validation_error | 422 | 27.85 | ✅ | 75/100 | ⚠️ |
| POST | `/api/elderly/medications/update` | ⚠️ validation_error | 422 | 27.07 | ✅ | 75/100 | ⚠️ |
| POST | `/api/elderly/appointments/sync` | ⚠️ validation_error | 422 | 28.42 | ✅ | 75/100 | ⚠️ |
| POST | `/api/elderly/appointments/update` | ⚠️ validation_error | 422 | 35.11 | ✅ | 75/100 | ⚠️ |
| GET | `/` | ⏭️ skipped | N/A | N/A | ✅ | N/A/100 | ✅ |
| GET | `/api/health` | ✅ success | 200 | 25.27 | ✅ | 80/100 | ✅ |
