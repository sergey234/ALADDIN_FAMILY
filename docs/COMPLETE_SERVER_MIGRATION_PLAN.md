...
4. Зафиксировать контрольные суммы и smoke-тесты текущего блока до копирования
5. Перенести SFM
6. Перенести валидатор
7. Перенести менеджеры (24 файла)
8. Перенести AI агенты (78 файлов)
9. Перенести боты (36 файлов)
10. Перенести данные SFM
11. Повторно проверить контрольные суммы/структуру и выполнить smoke-тест перенесённого блока
12. Проверить общую структуру и валидировать

> ⚠️ Перед каждым переносом фиксируем основные параметры и контрольные суммы текущей версии, после копирования — сверяем их и выполняем короткий smoke-тест блока. Так ничего не забываем и можем сразу ловить ошибки до перехода к следующему шагу.
