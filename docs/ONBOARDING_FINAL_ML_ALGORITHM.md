...
**Версия:** 2026-05-23 · **Проект:** `ALADDIN_iOS` only (не `ALADDIN_PUSH187`).  
**Figma file key:** `KvkUdyb5Ll31Z9FSzCbpNl` · env: `docs/FIGMA_ONBOARDING.env`.  
**Эталон координат OB_00–07:** `ONBOARDING_COORDINATES_AND_SYNC.md`
...
| **01** | 1 | 0 | `OB_01_Family_393x852` | `81:53` | `OnboardingHero_01` | ✅ **Принято** |
| **02** | 2 | 1 | `OB_02_AI_393x852` | `103:53` | `OnboardingHero_02` | ✅ **Принято** (zone94) |
...
|----|-------------------|-----------------|---------------|-------------|---------|------------|--------|
| **01** | 10,**354**,360,121 | 16,**536**,361,50 | 16,**615**,346,48 | **528**,324 | 0.45 | ✅ case 0 | ✅ |
| **02** | — | 10,**479**,361,60 | 7,**552**,364,79 | **552**,300 | 0.42 | ✅ case 1 | ✅ |
| **03** | — | 16,**552**,361,60 | 14,**630**,361,80 | **500**,320 | 0.40 | ✅ case 2 | ✅ H,T,I,C — ⏳ D |
| **04** | — | 16,**496**,361,60 | 16,**566**,361,100 | **542**,310 | 0.35 | ✅ case 3 | ⏳ D |
| **05** | — | 16,**496**,361,60 | 16,**566**,361,100 | **532**,320 | 0.38 | ✅ case 4 | ⏳ D |
| **06** | — | 16,**496**,361,60 | 16,**566**,361,100 | **552**,300 | 0.40 | ✅ case 5 | ⏳ D |
...
| iOS **Figma Y** anchors | ✅ | ✅ | ✅ | ✅ case 3 | ✅ case 4 | ✅ case 5 |
| Hero PNG = Figma upload | ✅ | ✅ zone94 | ✅ zone94 | ✅ | ✅ | ✅ |
| Scrim stops = код | ✅ | ✅ @0.45 | ✅ @0.4 | ✅ @0.45 | ✅ @0.45 | ✅ @0.45 |
| §D Visual QA | ⏳ | ⏳ | ⏳ | ⏳ | ⏳ | ⏳ |
