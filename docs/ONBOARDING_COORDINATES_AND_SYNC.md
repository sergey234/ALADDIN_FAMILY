...
|----|---------------------|----------------|--------|-------------|------------|---------------|---------|----------------|
| **01** | Защита всей семьи… | 0 | 0 | **508** | **593** | **528×324** | 0.45 | 4 |
| **02** | Персональный агент… | 1 | 1 | **494** | **577** | **552×300** | 0.42 | 6 |
| **03** | Родительский контроль | 2 | 2 | **552** | **630** | **500×320** | 0.40 | 5 |
| **04** | Аналитика рисков | 3 | 3 | **468** | **544** | **542×310** | 0.35 | 5 |
| **05** | Защита для детей! | 4 | 4 | **468** | **544** | **532×320** | 0.38 | 6 |
...
**SYNC 2026-05-25:** title/desc +28/+22 pt, desc h **112** (build **206**)
