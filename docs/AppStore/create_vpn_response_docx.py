...
# -*- coding: utf-8 -*-
"""
Скрипт для создания DOCX файла с ответом Apple по VPN
"""
...
def create_docx():
    ...
    russian_file = os.path.join(script_dir, 'ОТВЕТ_APPLE_VPN_BUILD_12_ФИНАЛ_19_12_2025.txt')
    english_file = os.path.join(script_dir, 'ОТВЕТ_APPLE_VPN_BUILD_12_ФИНАЛ_19_12_2025_ENGLISH.txt')
    ...
    # Сохраняем
    output_path = '/Users/sergejhlystov/Downloads/ОТВЕТ_APPLE_BUILD_13_19_12_2025.docx'
