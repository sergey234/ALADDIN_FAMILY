# Релизный промпт ALADDIN iOS (актуально после build 1 (компания ai.aladdin / ALADDIN AI))
...
> **Путь B / компания:** нумерация с **1** для нового ASC app `ai.aladdin`. Личный TF (`family.aladdin.ios`) имел свою линейку до 248 — это другое приложение, номера не обязаны продолжаться.
