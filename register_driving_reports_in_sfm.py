...
# -*- coding: utf-8 -*-
"""
Скрипт для регистрации Driving Reports Agent в SFM

Использование:
    python3 register_driving_reports_in_sfm.py
...
ENTRY_PATH = Path("/tmp/function_registry_entry_driving_reports.json")
BACKUP_PATH = REGISTRY_PATH.with_suffix(f".json.backup_driving_reports_{datetime.now().strftime('%Y%m%d_%H%M%S')}")


def main():
    print("=" * 60)
    print("РЕГИСТРАЦИЯ DRIVING REPORTS AGENT В SFM")
    print("=" * 60)
