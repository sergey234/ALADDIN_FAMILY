...
struct OnboardingScreen: View {
    ...
    private let pages: [OnboardingPage] = [
        ...
        OnboardingPage(
            ...
            description: "Вы видите весь интернет детей",
            color: Color.orange
        ),
        ...
        OnboardingPage(
            icon: "🦄", // Fallback иконка, если нет логотипа
        ...
        VStack(spacing: Spacing.xxl) {
            ...
            if index == 6 { // Страница 7 (индекс 6)
                ...
                ZStack {
                    ...
                    // Приоритет: изображение профиля > логотип приложения > fallback иконка
                ...
                .accessibilityLabel("Логотип приложения ALADDIN")
            } else {
