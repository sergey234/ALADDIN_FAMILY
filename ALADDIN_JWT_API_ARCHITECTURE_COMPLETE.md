...
- [ ] **Trial активация:** Реальный API → настоящий JWT → все функции работают
- [ ] **AI Assistant:** Только серверные ответы, без fallback
- [ ] **API endpoints:** Все 193 работают без mock данных
- [ ] **Upgrade flow:** Trial → Paid работает корректно
- [ ] **JWT tokens:** Валидные для всех тарифов
- [ ] **Functions:** Все 184 активируются правильно
