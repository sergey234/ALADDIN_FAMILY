...
| POST | `/api/ai/companion/chat` | `CompanionAPIService.sendChat` + body `guide_mode` | `ai_companion_router` + `wellness_guide_role.py` (deployed VPS 2026-07-21) | ✅ маршрут жив + `guide_mode`; LLM сейчас **503** `AI service unavailable` (Hermes/OpenRouter 403, Gemini 503 — ключи/политика, не роутинг) |
