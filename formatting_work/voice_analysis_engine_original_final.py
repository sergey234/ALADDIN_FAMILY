...
class VoiceAnalysisEngine(SecurityBase):
    ...
    def add_to_history(self, analysis_result: Dict[str, Any]) -> None:
        """Добавить результат анализа в историю"""
    ...
    async def _extract_voice_features(
        ...
        try:
            ...
            # mfcc = [[0.1] * self.n_mfcc]  # Заглушка для будущего
    ...
    async def _detect_manipulation(
        ...
        try:
            ...
            if voice_features.pitch_std > 40:
                indicators["authority_appeal"] += 0.2
    ...
    async def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "statistics": {
                ...
                "recent_analyses": len(self.get_analysis_history(10)),
            }
        }
