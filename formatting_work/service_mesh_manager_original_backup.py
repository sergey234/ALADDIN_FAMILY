...
class ServiceMeshManager(SecurityBase):
    ...
    def _least_connections_selection(self, service_id: str,
    ...
    def _weighted_round_robin_selection(self, service_id: str,
                                        endpoints: List[ServiceEndpoint]) -> Optional[ServiceEndpoint]:
    ...
    def _least_response_time_selection(self, service_id: str,
                                       endpoints: List[ServiceEndpoint]) -> Optional[ServiceEndpoint]:
    ...
    def send_request(self, service_id: str, method: str, path: str,
