...
class SleepModeManager:
    ...
    async def register_bot(self, bot_name: str, bot_instance: Any) -> bool:
        ...
        try:
            ...
            self.bot_instances[bot_name] = {
                ...
                "priority": self.sleep_config.get("bots", {}).get(bot_name, {}).get("priority", 99)
            }
            ...
            await self._trigger_event("bot_registered", bot_name, {"bot_instance": str(type(bot_instance))})
    ...
    async def put_bot_to_sleep(
        ...
        try:
            ...
            # ВЫЗОВ СОБЫТИЙНЫХ CALLBACK'ОВ
            await self._trigger_event("bot_sleep", bot_name, {
                "reason": reason,
                "sleep_time": bot_info["sleep_time"].isoformat()
            })
    ...
    async def start_system(self) -> bool:
        ...
        try:
            ...
            # ВЫЗОВ СОБЫТИЙНЫХ CALLBACK'ОВ
            await self._trigger_event("system_started", "system", {
    ...
    async def stop_system(self) -> bool:
        ...
        try:
            ...
            # ВЫЗОВ СОБЫТИЙНЫХ CALLBACK'ОВ
            await self._trigger_event("system_stopping", "system", {
    ...
    async def _check_system_health(self) -> bool:
        ...
        try:
            ...
            try:
                Path(self.sleep_config_path).parent.mkdir(parents=True, exist_ok=True)
                test_file = Path(self.sleep_config_path).parent / "health_check.tmp"
            ...
            if self.performance_metrics["validation_errors"] > 10:
                health_issues.append(f"Слишком много ошибок валидации: {self.performance_metrics['validation_errors']}")
    ...
    async def _trigger_event(self, event_type: str, bot_name: str, data: Dict[str, Any]) -> None:
        """Вызов событийных callback'ов"""
        try:
    ...
    def add_event_callback(self, callback: Callable[[str, str, Dict[str, Any]], None]) -> bool:
    ...
    def get_performance_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "total_sleep_operations": self.performance_metrics["total_sleep_operations"],
                "total_wake_operations": self.performance_metrics["total_wake_operations"],
                "total_operations": self.performance_metrics["total_sleep_operations"] + 
                ...
                "last_operation_time": self.performance_metrics["last_operation_time"].isoformat() 
                                     if self.performance_metrics["last_operation_time"] else None,
                "registered_bots": len(self.bot_instances),
