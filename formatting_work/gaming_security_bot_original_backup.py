...
class GamingSecurityBot(SecurityBase):
    ...
    async def _detect_cheat(self,
                            action: PlayerAction,
                            coordinates: Optional[Dict[str,
                                                       float]],
                            context: Optional[Dict[str,
                                                   Any]],
                            session: GameSession) -> Tuple[CheatType,
                                                           float,
                                                           ThreatLevel]:
        """Детекция читов"""
        try:
    ...
    async def analyze_transaction(self, player_id: str, session_id: str,
    ...
    async def end_game_session(self, session_id: str, final_score: int = 0,
