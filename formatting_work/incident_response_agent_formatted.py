        ...
        try:
            ...
            self.response_plans["malware"] = {
                ...
                "steps": [
                    ...
                    {
                        "action": "QUARANTINE",
                        "description": "Поместить в карантин подозрительные файлы",
                    },
                    {
                        "action": "INVESTIGATE",
                    ...
                    {
                        "action": "RESTORE",
                        "description": "Восстановить системы из резервных копий",
                    },
                ],
                "priority": 1,
            ...
            self.response_plans["phishing"] = {
                ...
                "steps": [
                    {
                        "action": "BLOCK",
                        "description": "Заблокировать подозрительные URL и email",
                    },
                    {
                        "action": "NOTIFY",
                        "description": "Уведомить пользователей о фишинговой атаке",
                    },
                    {
                        "action": "INVESTIGATE",
            ...
            self.response_plans["ddos"] = {
                ...
                "steps": [
                    {
                        "action": "BLOCK",
                        "description": "Заблокировать атакующий трафик",
                    },
                    {
                        "action": "ESCALATE",
                        "description": "Эскалировать в команду сетевой безопасности",
                    },
                    {
                        "action": "MONITOR",
            ...
            self.response_plans["data_breach"] = {
                ...
                "steps": [
                    {
                        "action": "ISOLATE",
                        "description": "Изолировать затронутые системы",
                    },
                    {
                        "action": "INVESTIGATE",
                        "description": "Провести расследование масштаба утечки",
                    },
                    {
                        "action": "NOTIFY",
                    ...
                    {
                        "action": "ESCALATE",
                        "description": "Эскалировать в руководство и регуляторы",
                    },
