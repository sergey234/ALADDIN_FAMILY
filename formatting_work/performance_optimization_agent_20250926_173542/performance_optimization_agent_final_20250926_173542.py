...
class PerformanceMetric:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        Example:
            ...
            ...     "cpu_usage", OptimizationType.CPU, 75.5, "%"
            ... )
            >>> data = metric.to_dict()
...
class OptimizationRecommendation:
    ...
    def __post_init__(self):
        ...
        Устанавливает пустой список prerequisites по умолчанию,
        если он не указан.
        Автоматически вызывается после создания экземпляра dataclass.
        """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        Example:
            ...
            ...     "rec1", OptimizationType.CPU, OptimizationLevel.HIGH,
            ...     "Оптимизация CPU"
            ... )
            >>> data = rec.to_dict()
...
class OptimizationMetrics:
    ...
    def __post_init__(self):
        ...
        Устанавливает значения по умолчанию для словарей и времени
