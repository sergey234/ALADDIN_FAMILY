...
class ContextAwareAccess(SecurityBase):
    ...
    def __str__(self) -> str:
        ...
        return f"ContextAwareAccess(rules={len(self.access_rules)}, decisions={len(self.access_decisions)})"

    def __repr__(self) -> str:
        """Техническое представление объекта"""
        return f"ContextAwareAccess(name='{self.name}', rules={len(self.access_rules)})"
