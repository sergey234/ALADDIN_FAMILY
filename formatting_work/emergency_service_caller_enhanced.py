...
class EmergencyServiceCaller:
    ...
    def get_service_statistics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if not hasattr(self, 'service_calls'):
                self.logger.warning("service_calls attribute not found, initializing")
                self.service_calls = {}
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, EmergencyServiceCaller):
            return False
        return (
            self.service_calls == other.service_calls and
    ...
    def __hash__(self) -> int:
        ...
        emergency_services_hash = hash(tuple(sorted(
            service_type.value for service_type in self.emergency_services.keys()
        )))
