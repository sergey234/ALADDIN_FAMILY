...
class IncognitoProtectionBot:
    ...
    def __init__(self, name: str = "IncognitoProtectionBot"):
        ...
        self.blocked_vpn_providers = [
            ...
            "windscribe", "tunnelbear", "private internet access", "ipvanish",
            "vyprvpn", "strongvpn", "hide.me", "purevpn", "zenmate"
        ]
        
        self.blocked_tor_indicators = [
            "tor browser", "torproject", "onion", ".onion", "tor network"
        ]
    ...
    async def detect_vpn_connection(self, child_id: str) -> VPNDetection:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if vpn_detected:
                    vpn_provider = next(
                        provider for provider in self.blocked_vpn_providers
    ...
    async def detect_incognito_mode(self, child_id: str) -> IncognitoDetection:
        ...
        try:
            ...
            incognito_indicators = [
                '--incognito', '--private', '--inprivate', '--stealth',
            ...
            if incognito_detected:
                ...
                with sqlite3.connect(self.db_path) as conn:
                    ...
                    """, (
                        detection_id, child_id, browser_type, detection_method,
                        0.8, json.dumps({}), datetime.now(), True
                    ))
            ...
            with sqlite3.connect(self.db_path) as conn:
                ...
                return {
                    ...
                    "incognito_detections": {
                        ...
                        "blocked": incognito_stats[1] if incognito_stats else 0
                    },
