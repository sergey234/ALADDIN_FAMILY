...
async def put_systems_to_sleep():
    ...
    try:
        ...
        rate_limiter = RateLimiter("RateLimiter_Sleep", sleep_config)
        ...
        circuit_breaker = CircuitBreaker("CircuitBreaker_Sleep", sleep_config)
        ...
        ui_manager = UserInterfaceManager(
            "UserInterfaceManager_Sleep", sleep_config
        )
...
def main():
    ...
    try:
        ...
        result = asyncio.run(put_systems_to_sleep())
