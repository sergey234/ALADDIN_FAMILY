...
class EncryptionManager:
    ...
    def __eq__(self, other) -> bool:
        ...
        if not isinstance(other, EncryptionManager):
            return False
        return (
            self.active_key_id == other.active_key_id and
            self.default_algorithm == other.default_algorithm and
            self.key_derivation == other.key_derivation and
    ...
    def get_usage_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "error_rate": (
                self._error_count / (self._encryption_count + self._decryption_count)
