...
from security.ai_agents.emergency_models import (
    EmergencyEvent, EmergencyContact, EmergencyType, EmergencySeverity,
    EmergencyResponse, EmergencyConfiguration
)
...
from security.ai_agents.emergency_notification_manager import EmergencyNotificationManager
from security.microservices.emergency_service_caller import EmergencyServiceCaller
...
class EmergencyService(SecurityBase):
    ...
    def create_emergency_event(self, emergency_type: EmergencyType,
