...
class EmergencyContactManager:
    ...
    def __str__(self) -> str:
        ...
        """
        return (f"EmergencyContactManager(contacts={len(self.contacts)}, "
    ...
    def __repr__(self) -> str:
        ...
        """
        return (f"EmergencyContactManager(contacts={self.contacts}, "
    ...
    def export_contacts(self, filepath: str) -> bool:
        ...
        try:
            ...
            export_data = {"contacts": [], "groups": self.contact_groups}
