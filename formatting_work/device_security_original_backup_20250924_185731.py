...
class DeviceSecurityService(SecurityBase):
    ...
    def register_device(self, device_name: str, device_type: DeviceType,
                        operating_system: str, os_version: str,
                        user_id: Optional[str] = None,
                        family_role: Optional[str] = None) -> DeviceProfile:
    ...
    def _calculate_security_score(self, device_profile: DeviceProfile,
    ...
    def _generate_recommendations(self, device_profile: DeviceProfile,
    ...
    def get_device_security_summary(self, user_id: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            if user_id:
                ...
                user_devices = [
                    device for device in self.device_profiles.values()
