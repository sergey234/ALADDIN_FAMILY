...
from security.ai_agents.emergency_models import EmergencyEvent, EmergencyResponse, EmergencyService
...
class EmergencyServiceCaller:
    ...
    def _initialize_emergency_services(self) -> Dict[EmergencyService, Dict[str, Any]]:
        """
    ...
    def call_emergency_service(self, event: EmergencyEvent,
                             service_type: EmergencyService) -> EmergencyResponse:
        """
    ...
    def _send_service_request(self, service_config: Dict[str, Any],
    ...
    def get_nearest_services(self, event: EmergencyEvent,
        ...
        try:
            ...
            filtered_services = [
                service for service in nearest_services
    ...
    def get_responses_for_event(self, event_id: str) -> List[EmergencyResponse]:
        ...
        """
        return [response for response in self.service_calls.values()
    ...
    def get_service_statistics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            dispatched_calls = len([r for r in self.service_calls.values()
                                 if r.status == 'dispatched'])
            arrived_calls = len([r for r in self.service_calls.values()
                               if r.status == 'arrived'])
            completed_calls = len([r for r in self.service_calls.values()
