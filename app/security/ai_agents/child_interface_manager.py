...
try:
    ...
    from security.core.security_base import BaseAgent
except ImportError:
...
class ChildAgeCategory(Enum):
    ...
    def __lt__(self, other) -> bool:
        ...
        age_order = [self.TODDLER, self.CHILD, self.TWEEN, self.TEEN,
                     self.YOUNG_ADULT]
...
class GameLevel(Enum):
    ...
    def __lt__(self, other) -> bool:
        ...
        if not isinstance(other, GameLevel):
            return NotImplemented
        level_order = [self.BEGINNER, self.EXPLORER, self.GUARDIAN,
    ...
    def required_score(self) -> int:
        ...
        level_scores = {self.BEGINNER: 0, self.EXPLORER: 100,
                        self.GUARDIAN: 300, self.EXPERT: 600,
                        self.MASTER: 1000}
...
class ChildInterfaceManager(BaseAgent):
    ...
    def detect_age_category(self, user_data: Dict[str, Any]
                            ) -> ChildAgeCategory:
        ...
        try:
            ...
            self.log_error(f"Ошибка определения возрастной категории: "
                           f"{str(e)}")
    ...
    def get_interface_for_age(self, age_category: Union[ChildAgeCategory, str]
                              ) -> Dict[str, Any]:
    ...
    def start_learning_module(self, age_category: Union[ChildAgeCategory, str],
    ...
    def complete_quest(self, user_id: str, quest_type: str,
    ...
    def send_parent_notification(self, parent_id: str, message: str,
                                 priority: str = "normal"
    ...
    def protect_privacy_data(self, user_data: Dict[str, Any]
                             ) -> Dict[str, Any]:
