...
# -*- coding: utf-8 -*-
"""
Enhanced Data Collector - Расширенный сборщик данных
для повышения точности ML моделей
"""
        ...
        self.data_sources = {
            ...
            "news_sources": {
                ...
                "interfax": {
                    ...
                    "search_url": (
                        "https://www.interfax.ru/search/?query={query}"
                    ),
                    "keywords": [
                        "мошенничество",
                        "фишинг",
                ...
                try:
                    ...
                    for keyword in source_config["keywords"]:
                        try:
                            ...
                            logger.warning(
                                f"⚠️ Ошибка поиска по ключевому слову "
                                f"{keyword}: {e}"
                            )
                            continue
...
async def main():
    ...
    try:
        ...
        print("✅ Расширенный сбор данных завершен!")
