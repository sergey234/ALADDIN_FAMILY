...
async def send_test_notification(
    ...
    try:
        ...
        test_notification = await family_notification_manager_enhanced.send_family_alert(
            family_id=family_id,
        ...
        return {
            "success": True,
            "notification_id": test_notification.notification_id if hasattr(test_notification, "notification_id") else "test_001",
            "message": "Тестовое уведомление отправлено"
        }
    except Exception as e:
        logger.error(f"Ошибка в send_test_notification: {str(e)}", exc_info=True)
