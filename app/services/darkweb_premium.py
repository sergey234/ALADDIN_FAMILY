"""Premium gate for darkweb API (dw-07)."""
...
def user_has_darkweb_access(user: Dict[str, Any], smoke_secret: str | None = None) -> bool:
    expected = os.environ.get("DARKWEB_INTERNAL_SMOKE_SECRET")
    if expected and smoke_secret and smoke_secret == expected:
        return True

    if os.environ.get("DARKWEB_ALLOW_FREE") == "1":
        return True
